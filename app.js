...
{
	if (region.bj.aH === region.bE.aH)
	{
		return 'on line ' + region.bj.aH;
	}
	return 'on lines ' + region.bj.aH + ' through ' + region.bE.aH;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		$elm$core$Maybe$isJust(request.dw) && _Http_track(router, xhr, request.dw.a);

		try {
			xhr.open(request.c$, request.u, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bI: fragment, bQ: host, b0: path, b2: port_, b5: protocol, b6: query};
	});
...
var $author$project$Main$EnteringUrl = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$GotReplay = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$GotTrainingCourtLog = F4(
	function (a, b, c, d) {
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cv: false, cB: r.cB, ah: r.ah, cU: r.cU, c$: r.c$, du: r.du, dw: r.dw, u: r.u}));
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$trainingCourtAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl1cnV2cGJnc3VrcWlhZWR1YWF5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjM2NDA2MDcsImV4cCI6MjAzOTIxNjYwN30.GtRRwMpiMMmbcpUci9xXqthWhgL5daKvsUZUaRgFPkI';
var $author$project$Main$trainingCourtSupabaseUrl = 'https://yuruvpbgsukqiaeduaay.supabase.co';
var $author$project$Main$fetchTrainingCourtLog = F4(
	function (uuid, idx, gIdx, flip) {
		return $elm$http$Http$request(
			{
				cB: $elm$http$Http$emptyBody,
				ah: A2(
					$elm$http$Http$expectJson,
					A3($author$project$Main$GotTrainingCourtLog, idx, gIdx, flip),
					A2(
				...
				cU: _List_fromArray(
					[
						A2($elm$http$Http$header, 'apikey', $author$project$Main$trainingCourtAnonKey),
						A2($elm$http$Http$header, 'Authorization', 'Bearer ' + $author$project$Main$trainingCourtAnonKey)
					]),
				c$: 'GET',
				du: $elm$core$Maybe$Nothing,
				dw: $elm$core$Maybe$Nothing,
				u: $author$project$Main$trainingCourtSupabaseUrl + ('/rest/v1/logs?select=log&id=eq.' + uuid)
			});
	});
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cB: $elm$http$Http$emptyBody, ah: r.ah, cU: _List_Nil, c$: 'GET', du: $elm$core$Maybe$Nothing, dw: $elm$core$Maybe$Nothing, u: r.u});
};
...
var $author$project$Main$trainingCourtLogId = function (url) {
	var _v0 = A2($elm$core$String$split, 'trainingcourt.app/ptcg/logs/', url);
	if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
		...
		return $elm$core$String$isEmpty(uuid) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(uuid);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Main$init = function (flags) {
	var url = $elm$core$String$trim(flags.b8);
	if ($elm$core$String$isEmpty(url)) {
		return _Utils_Tuple2(
			$author$project$Main$EnteringUrl(''),
			$elm$core$Platform$Cmd$none);
	} else {
		var ctx = {S: flags.S, h: flags.h};
		var _v0 = $author$project$Main$trainingCourtLogId(url);
		if (!_v0.$) {
			var uuid = _v0.a;
			return _Utils_Tuple2(
				A4($author$project$Main$Loading, url, flags.aZ, flags.B, ctx),
				A4($author$project$Main$fetchTrainingCourtLog, uuid, flags.aZ, flags.B, flags.h));
		} else {
			return _Utils_Tuple2(
				A4($author$project$Main$Loading, url, flags.aZ, flags.B, ctx),
				$elm$http$Http$get(
					{
						ah: $elm$http$Http$expectString($author$project$Main$GotReplay),
						u: url
					}));
		}
	}
...
var $author$project$Main$FetchingCard = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Main$FetchingMove = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $author$project$Main$NextSection = {$: 6};
var $author$project$Main$PrevSection = {$: 5};
var $author$project$Main$Retrying = F4(
	function (a, b, c, d) {
...
var $author$project$Main$currentDebug = function (model) {
	switch (model.$) {
		case 1:
			var ctx = model.d;
			return ctx.S;
...
var $author$project$Main$currentFlipOpponent = function (model) {
	switch (model.$) {
		case 1:
			var ctx = model.d;
			return ctx.h;
...
var $author$project$Main$CardAbility = F3(
	function (abilityType, name, effect) {
		return {bo: abilityType, aF: effect, aI: name};
	});
var $author$project$Main$CardAttack = F4(
	function (name, cost, damage, effect) {
		return {a5: cost, cI: damage, aF: effect, aI: name};
	});
var $author$project$Main$CardData = F5(
	function (imageUrl, attacks, abilities, category, name) {
		return {a1: abilities, a3: attacks, bw: category, ak: imageUrl, aI: name};
	});
...
var $author$project$Main$decodeCardData = function (body) {
	var attackDecoder = A5(
		$elm$json$Json$Decode$map4,
		$author$project$Main$CardAttack,
		...
		$elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					A2($elm$json$Json$Decode$field, 'effect', $elm$json$Json$Decode$string),
					$elm$json$Json$Decode$succeed('')
				])));
	var abilityDecoder = A4(
		$elm$json$Json$Decode$map3,
		$author$project$Main$CardAbility,
		A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'effect', $elm$json$Json$Decode$string));
	var cardDecoder = A6(
		$elm$json$Json$Decode$map5,
		$author$project$Main$CardData,
		...
		$elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					...
					$elm$json$Json$Decode$field,
					'attacks',
					$elm$json$Json$Decode$list(attackDecoder)),
					$elm$json$Json$Decode$succeed(_List_Nil)
				])),
		$elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					...
					$elm$json$Json$Decode$field,
					'abilities',
					$elm$json$Json$Decode$list(abilityDecoder)),
					$elm$json$Json$Decode$succeed(_List_Nil)
				])),
		$elm$json$Json$Decode$maybe(
	...
	return $elm$core$Result$toMaybe(
		A2($elm$json$Json$Decode$decodeString, cardDecoder, body));
};
...
var $author$project$Main$setActive = F4(
	function (red, player, card, active) {
		return _Utils_eq(player, red) ? _Utils_update(
			active,
			{
				a: $elm$core$Maybe$Just(card)
			}) : _Utils_update(
			active,
			{
				b: $elm$core$Maybe$Just(card)
			});
	});
	...
	function (red, action, active) {
		switch (action.$) {
			...
			case 11:
				var player = action.a.d;
				var card = action.a.e;
				var andPlayed = action.a.cw;
				if ((!andPlayed.$) && (!andPlayed.a)) {
					var _v3 = andPlayed.a;
					return A4($author$project$Main$setActive, red, player, card, active);
				} else {
					return active;
			...
			case 14:
				...
				if (!position) {
					var matches = function (side) {
						if (!side.$) {
							var c = side.a;
							return _Utils_eq(c.T, from.T);
						} else {
							return false;
						}
					};
					return (_Utils_eq(player, red) && matches(active.a)) ? _Utils_update(
						active,
						{
							a: $elm$core$Maybe$Just(to)
						}) : (((!_Utils_eq(player, red)) && matches(active.b)) ? _Utils_update(
						active,
						{
							b: $elm$core$Maybe$Just(to)
						}) : active);
				} else {
					return active;
				}
			case 16:
				...
				var matches = function (side) {
					if (!side.$) {
						var c = side.a;
						return _Utils_eq(c.T, pokemon.e.T);
					} else {
						return false;
					}
				};
				return (_Utils_eq(pokemon.d, red) && matches(active.a)) ? _Utils_update(
					active,
					{a: $elm$core$Maybe$Nothing}) : (((!_Utils_eq(pokemon.d, red)) && matches(active.b)) ? _Utils_update(
					active,
					{b: $elm$core$Maybe$Nothing}) : active);
			case 20:
				var pokemon = action.a.t;
				return A4($author$project$Main$setActive, red, pokemon.d, pokemon.e, active);
			case 22:
				var player = action.a.d;
				var from = action.a.a7;
			...
			case 21:
				...
				return (_Utils_eq(player, red) && matches(active.a)) ? _Utils_update(
					active,
					{a: $elm$core$Maybe$Nothing}) : (((!_Utils_eq(player, red)) && matches(active.b)) ? _Utils_update(
					active,
					{b: $elm$core$Maybe$Nothing}) : active);
			default:
				return active;
...
var $author$project$Main$applyGroupToActive = F3(
	function (red, active, group) {
		var active1 = A3($author$project$Main$applyActionToActive, red, group.R, active);
		return A3(
			$elm$core$List$foldl,
			F2(
				function (detail, a) {
					return A3(
						...
						F2(
							function (bullet, ba) {
								return A3($author$project$Main$applyActionToActive, red, bullet.R, ba);
							}),
						A3($author$project$Main$applyActionToActive, red, detail.R, a),
						detail.az);
				}),
			active1,
			group.bC);
...
var $author$project$Main$retireFirstInstance = F3(
	function (player, cardId, state) {
		...
		var activeIid = A2(
			...
			$elm$core$Basics$identity,
			A2($elm$core$Dict$get, key, state.g));
		if (!activeIid.$) {
			return _Utils_update(
				state,
				{
					g: A3($elm$core$Dict$insert, key, $elm$core$Maybe$Nothing, state.g)
				});
		} else {
			return _Utils_update(
				state,
...
var $author$project$Main$transferFirstInstanceActive = F4(
	function (player, fromId, toId, state) {
		...
		var maybeIid = A2(
			$elm$core$Maybe$andThen,
			$elm$core$Basics$identity,
			A2($elm$core$Dict$get, fromKey, state.g));
		if (maybeIid.$ === 1) {
			return state;
		} else {
			var iid = maybeIid.a;
			return _Utils_update(
				state,
				{
					g: A3(
						...
						toKey,
						$elm$core$Maybe$Just(iid),
						A3($elm$core$Dict$insert, fromKey, $elm$core$Maybe$Nothing, state.g))
				});
		}
	});
var $author$project$Main$transferFirstInstanceBench = F4(
	function (player, fromId, toId, state) {
		...
		var maybeIid = A2(
			$elm$core$Maybe$andThen,
			$elm$core$List$head,
			A2($elm$core$Dict$get, fromKey, state.i));
		if (maybeIid.$ === 1) {
			return state;
		} else {
			var iid = maybeIid.a;
	...
	function (action, state) {
		switch (action.$) {
			case 6:
				...
				var card = action.a.e;
				var position = action.a.aL;
				var _v1 = A3($author$project$Main$assignInstance, player, card.T, state);
				var s1 = _v1.a;
				var iid = _v1.b;
				if (position === 1) {
					return A4($author$project$Main$addToBenchInstances, player, card.T, iid, s1);
				} else {
					return A4($author$project$Main$setActiveInstance, player, card.T, iid, s1);
				}
			case 11:
				var player = action.a.d;
				var card = action.a.e;
				...
				if (!andPlayed.$) {
					var pos = andPlayed.a;
					var _v4 = A3($author$project$Main$assignInstance, player, card.T, state);
					var s1 = _v4.a;
					var iid = _v4.b;
					if (pos === 1) {
						return A4($author$project$Main$addToBenchInstances, player, card.T, iid, s1);
			...
			case 16:
				var pokemon = action.a.t;
				return A3($author$project$Main$retireFirstInstance, pokemon.d, pokemon.e.T, state);
			case 14:
				var player = action.a.d;
				var from = action.a.a7;
				var to = action.a.bn;
				var position = action.a.aL;
				if (position === 1) {
					return A4($author$project$Main$transferFirstInstanceBench, player, from.T, to.T, state);
				} else {
					return A4($author$project$Main$transferFirstInstanceActive, player, from.T, to.T, state);
				}
			case 20:
				var pokemon = action.a.t;
				var key = _Utils_Tuple2(pokemon.d, pokemon.e.T);
				var _v7 = A2(
					$elm$core$Maybe$andThen,
					$elm$core$Basics$identity,
					A2($elm$core$Dict$get, key, state.g));
				if (!_v7.$) {
					...
					var excludeIid = A2($elm$core$Dict$get, key, state.I);
					var benchList = A2(
						$elm$core$Maybe$withDefault,
						_List_Nil,
						A2($elm$core$Dict$get, key, state.i));
						...
						return _Utils_update(
							state,
							{
								...
								i: A3(
									...
									state.i),
								I: A2($elm$core$Dict$remove, key, state.I)
							});
					}
				}
			case 22:
				...
				var from = action.a.a7;
				var to = action.a.bn;
				if (_Utils_eq(from.T, to.T) && (!$elm$core$String$isEmpty(from.T))) {
					var key = _Utils_Tuple2(player, from.T);
					var benchHead = A2(
						$elm$core$Maybe$andThen,
						$elm$core$List$head,
						A2($elm$core$Dict$get, key, state.i));
						...
						return _Utils_update(
							state,
							{
								...
								i: A3(
									...
									state.i),
								I: A3($elm$core$Dict$insert, key, aIid, state.I)
							});
					} else {
						return state;
					}
				} else {
					var toKey = _Utils_Tuple2(player, to.T);
					var toIid = A2(
						$elm$core$Maybe$andThen,
						$elm$core$Basics$identity,
						A2($elm$core$Dict$get, toKey, state.g));
					var fromKey = _Utils_Tuple2(player, from.T);
					var fromIid = A2(
						$elm$core$Maybe$andThen,
						$elm$core$List$head,
						A2($elm$core$Dict$get, fromKey, state.i));
					return _Utils_update(
						state,
						{
							g: ($elm$core$String$isEmpty(to.T) ? $elm$core$Basics$identity : A2($elm$core$Dict$insert, toKey, $elm$core$Maybe$Nothing))(
								function () {
									if (!fromIid.$) {
										var iid = fromIid.a;
										return A2(
							...
							i: function () {
								if ($elm$core$String$isEmpty(to.T)) {
									return $elm$core$Basics$identity;
								} else {
									if (!toIid.$) {
										var iid = toIid.a;
							...
							I: function () {
								if (!toIid.$) {
									var iid = toIid.a;
									return A3($elm$core$Dict$insert, toKey, iid, state.I);
								} else {
									return state.I;
								}
							}()
			...
			case 21:
				var player = action.a.d;
				var card = action.a.e;
				var key = _Utils_Tuple2(player, card.T);
				var maybeIid = A2(
					$elm$core$Maybe$andThen,
					$elm$core$Basics$identity,
					A2($elm$core$Dict$get, key, state.g));
					...
					return _Utils_update(
						state,
						{
							...
							i: A3(
								...
								state.i),
							I: A3($elm$core$Dict$insert, key, iid, state.I)
						});
				}
			default:
				return state;
...
var $author$project$Main$applyDetailToInstances = F2(
	function (detail, state) {
		...
		if (_v0.$ === 12) {
			var player = _v0.a.d;
			var position = _v0.a.aL;
			if (position === 1) {
				return A3(
					$elm$core$List$foldl,
					F2(
						function (card, s) {
							var _v2 = A3($author$project$Main$assignInstance, player, card.T, s);
							var s1 = _v2.a;
							var iid = _v2.b;
							return A4($author$project$Main$addToBenchInstances, player, card.T, iid, s1);
						}),
			...
			return A2($author$project$Main$applyActionToInstances, detail.R, state);
		}
	});
var $author$project$Main$applyGroupToInstances = F2(
	function (group, state) {
		var s1 = A2($author$project$Main$applyActionToInstances, group.R, state);
		return A3(
			$elm$core$List$foldl,
			F2(
				function (detail, s) {
					...
					return A3(
						...
						F2(
							function (bullet, bs) {
								return A2($author$project$Main$applyActionToInstances, bullet.R, bs);
							}),
						s2,
						detail.az);
				}),
...
var $author$project$Action$ActiveSpot = 0;
var $author$project$Action$Attached = function (a) {
	return {$: 13, a: a};
};
var $author$project$Action$BenchSpot = 1;
	...
	if (A2($elm$core$String$startsWith, '(', trimmed)) {
		...
		if (_v0.b) {
			...
			return $author$project$Action$isCardId(rawId) ? $elm$core$Maybe$Just(
				{T: rawId, aI: name}) : $elm$core$Maybe$Nothing;
		} else {
			return $elm$core$Maybe$Nothing;
		}
	} else {
...
var $author$project$Action$tryAttached = function (raw) {
	if (A2($elm$core$String$contains, ' attached ', raw)) {
		var position = A2($elm$core$String$contains, ' on the Bench.', raw) ? $elm$core$Maybe$Just(1) : (A2($elm$core$String$contains, ' in the Active Spot.', raw) ? $elm$core$Maybe$Just(0) : $elm$core$Maybe$Nothing);
		if (position.$ === 1) {
			return $elm$core$Maybe$Nothing;
		} else {
			var pos = position.a;
			...
			if ((_v1.b && _v1.b.b) && (!_v1.b.b.b)) {
				...
				if ((_v3.b && _v3.b.b) && (!_v3.b.b.b)) {
					...
					if ((!_v5.a.$) && (!_v5.b.$)) {
						...
						var pCard = _v5.b.a;
						var pokemon = {e: pCard, d: player};
						return $elm$core$Maybe$Just(
							$author$project$Action$Attached(
								{cY: itemCard, d: player, aL: pos, a_: pokemon}));
					} else {
						return $elm$core$Maybe$Nothing;
					}
				} else {
	...
	if (A2($elm$core$String$startsWith, 'A card was added to ', raw) && A2($elm$core$String$endsWith, '\'s hand.', raw)) {
		...
		return $elm$core$String$isEmpty(player) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			$author$project$Action$CardAddedToHand(
				{e: $elm$core$Maybe$Nothing, d: player}));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
		...
		if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
			...
			return $elm$core$Maybe$Just(
				$author$project$Action$ChoseOption(
					{
						de: $elm$core$String$trimRight(option),
						d: player
					}));
		} else {
			return $elm$core$Maybe$Nothing;
...
var $author$project$Action$tryDrewCard = function (raw) {
	if (A2($elm$core$String$contains, ' drew ', raw) && A2($elm$core$String$contains, ' and played it to ', raw)) {
		...
		if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
			...
			var _v1 = _v0.b;
			var rest = _v1.a;
			var andPlayed = A2($elm$core$String$contains, ' and played it to the Active Spot.', rest) ? $elm$core$Maybe$Just(0) : (A2($elm$core$String$contains, ' and played it to the Bench.', rest) ? $elm$core$Maybe$Just(1) : $elm$core$Maybe$Nothing);
			var _v2 = $author$project$Action$parseCardRef(rest);
			if (!_v2.$) {
				var card = _v2.a;
				return $elm$core$Maybe$Just(
					$author$project$Action$DrewCard(
						{cw: andPlayed, e: card, d: player}));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		} else {
						...
						if ((!_v7.a.$) && (!_v7.b.$)) {
							...
							return $elm$core$Maybe$Just(
								$author$project$Action$MovedDamageCounters(
									{l: n, a7: fromRef, d: mover, bn: toRef}));
						} else {
							return $elm$core$Maybe$Nothing;
						}
					} else {
			...
			if ((!_v2.a.$) && (!_v2.b.$)) {
				...
				return $elm$core$Maybe$Just(
					$author$project$Action$Switched(
						{a7: fromRef.e, d: fromRef.d, bn: toRef.e}));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		} else {
			...
			if (lines.b && (!lines.a.$)) {
				...
				if (_v1.$ === 26) {
					var $temp$lines = rest,
						...
						$elm$core$List$cons,
						{
							R: $author$project$Action$parseAction(raw),
							az: _List_Nil,
							X: raw
						},
						acc);
			...
			if (lines.b && (!lines.a.$)) {
				...
				var isMatchingDiscard = function () {
					...
					switch (_v2.$) {
						case 24:
							var pokemon = _v2.a.t;
							return _Utils_eq(pokemon.d, koPokemon.d) && _Utils_eq(pokemon.e.T, koPokemon.e.T);
						case 25:
							var pokemon = _v2.a.t;
							return _Utils_eq(pokemon.d, koPokemon.d) && _Utils_eq(pokemon.e.T, koPokemon.e.T);
						default:
			...
			if (!lines.b) {
				...
				if (!lines.a.$) {
					...
					var $temp$lines = finalRemaining,
						...
						{
							R: action,
							bC: _Utils_ap(details, extraDetails),
							X: raw
						},
						acc);
					lines = $temp$lines;
...
var $author$project$Main$collectAllGroups = F3(
	function (replay, sectionIndex, groupIndex) {
		return $elm$core$List$concat(
			A2(
				$elm$core$List$indexedMap,
				F2(
					function (si, section) {
						...
						return (_Utils_cmp(si, sectionIndex) < 0) ? groups : (_Utils_eq(si, sectionIndex) ? A2($elm$core$List$take, groupIndex + 1, groups) : _List_Nil);
					}),
				replay.y));
	});
...
var $author$project$Main$correctDetailPlayer = F2(
	function (players, detail) {
		...
		var hasRevealedCards = A2(
			...
			detail.az);
		var correctPlayer = hasRevealedCards ? players.a : players.b;
		var _v0 = detail.R;
		switch (_v0.$) {
			case 10:
				var player = _v0.a.d;
				...
				return (!_Utils_eq(player, correctPlayer)) ? _Utils_update(
					detail,
					{
						R: $author$project$Action$DrewCount(
							{l: count, d: correctPlayer}),
						X: A3(replacePlayer, player, correctPlayer, detail.X)
					}) : detail;
			case 31:
				var player = _v0.a.d;
				var card = _v0.a.e;
				...
				if (card.$ === 1) {
					return (!_Utils_eq(player, correctPlayer)) ? _Utils_update(
						detail,
						{
							R: $author$project$Action$ShuffledInto(
								{e: $elm$core$Maybe$Nothing, l: count, d: correctPlayer}),
							X: A3(replacePlayer, player, correctPlayer, detail.X)
						}) : detail;
				} else {
					return detail;
			...
			case 30:
				...
				if (card.$ === 1) {
					return (!_Utils_eq(player, correctPlayer)) ? _Utils_update(
						detail,
						{
							R: $author$project$Action$PutOnBottom(
								{e: $elm$core$Maybe$Nothing, l: count, d: correctPlayer}),
							X: A3(
								$elm$core$String$replace,
								player + '\'s',
								correctPlayer + '\'s',
								A3(replacePlayer, player, correctPlayer, detail.X))
						}) : detail;
				} else {
					return detail;
				}
...
var $author$project$Main$correctGroupPlayers = F3(
	function (players, instanceState, group) {
		...
		var otherPlayer = function (p) {
			return _Utils_eq(p, players.a) ? players.b : players.a;
		};
		...
		var correctDetail = function (detail) {
			...
			switch (_v0.$) {
				case 10:
					var player = _v0.a.d;
					var count = _v0.a.l;
					if (!shuffleDeckPlayer.$) {
						var sp = shuffleDeckPlayer.a;
						if (!_Utils_eq(player, sp)) {
							var raw = A3($elm$core$String$replace, player + ' drew', sp + ' drew', detail.X);
							return _Utils_update(
								detail,
								{
									R: $author$project$Action$DrewCount(
				...
				case 32:
					var player = _v0.a.d;
					if (!groupAttachPlayer.$) {
						var ap = groupAttachPlayer.a;
						return (!_Utils_eq(ap, player)) ? _Utils_update(
							detail,
							{
								R: $author$project$Action$ShuffledDeck(
									{d: ap}),
								X: A3($elm$core$String$replace, player + ' shuffled', ap + ' shuffled', detail.X)
							}) : detail;
					} else {
						return detail;
					}
				case 33:
					...
					var correctPlayer = function () {
						if (!groupAttachPlayer.$) {
							...
							if ($author$project$Main$isDeckAttachAbilityGroup(group)) {
								var _v5 = group.R;
								if (_v5.$ === 15) {
									var attacker = _v5.a.a2;
									return $elm$core$Maybe$Just(attacker.d);
								} else {
									return $elm$core$Maybe$Nothing;
								}
							} else {
					...
					if (!correctPlayer.$) {
						...
						return (!_Utils_eq(ap, player)) ? _Utils_update(
							detail,
							{
								R: $author$project$Action$ShuffledCards(
									{d: ap}),
								X: A3($elm$core$String$replace, player + ' shuffled', ap + ' shuffled', detail.X)
							}) : detail;
					} else {
				...
				case 39:
					...
					var correctPokemon = function (pokemon) {
						var other = otherPlayer(pokemon.d);
						return A2(playerHasPokemonOnBench, pokemon.d, pokemon.e.T) ? pokemon : (A2(playerHasPokemonActive, pokemon.d, pokemon.e.T) ? pokemon : (A2(playerHasPokemonOnBench, other, pokemon.e.T) ? _Utils_update(
							pokemon,
							{d: other}) : (A2(playerHasPokemonActive, other, pokemon.e.T) ? _Utils_update(
							pokemon,
							{d: other}) : pokemon)));
					};
					var correctedFrom = correctPokemon(from);
					var correctedTo = correctPokemon(to);
					var correctedRaw = ((!_Utils_eq(correctedTo.d, to.d)) ? A2($elm$core$String$replace, ' to ' + (to.d + '\'s'), ' to ' + (correctedTo.d + '\'s')) : $elm$core$Basics$identity)(
						((!_Utils_eq(correctedFrom.d, from.d)) ? A2($elm$core$String$replace, ' from ' + (from.d + '\'s'), ' from ' + (correctedFrom.d + '\'s')) : $elm$core$Basics$identity)(detail.X));
					return (_Utils_eq(correctedFrom, from) && _Utils_eq(correctedTo, to)) ? detail : _Utils_update(
						detail,
						{
							R: $author$project$Action$MovedDamageCounters(
								{l: count, a7: correctedFrom, d: player, bn: correctedTo}),
							X: correctedRaw
						});
				case 38:
					var player = _v0.a.d;
					...
					var count = _v0.a.l;
					var other = otherPlayer(pokemon.d);
					var correctedPlayer = A2(playerHasPokemonOnBench, pokemon.d, pokemon.e.T) ? pokemon.d : (A2(playerHasPokemonActive, pokemon.d, pokemon.e.T) ? pokemon.d : (A2(playerHasPokemonOnBench, other, pokemon.e.T) ? other : (A2(playerHasPokemonActive, other, pokemon.e.T) ? other : pokemon.d)));
					return _Utils_eq(correctedPlayer, pokemon.d) ? detail : _Utils_update(
						detail,
						{
							R: $author$project$Action$PlacedDamageCounters(
								{
									l: count,
									d: player,
									t: _Utils_update(
							...
							X: A3($elm$core$String$replace, ' on ' + (pokemon.d + '\'s'), ' on ' + (correctedPlayer + '\'s'), detail.X)
						});
				default:
					return detail;
			}
		...
		return _Utils_update(
			group,
			{
				bC: A2($elm$core$List$map, correctDetail, group.bC)
			});
	});
var $author$project$Main$emptyInstances = {g: $elm$core$Dict$empty, i: $elm$core$Dict$empty, I: $elm$core$Dict$empty, aJ: 0};
var $author$project$Main$collectAndCorrectGroups = F4(
			...
			A3(
				...
				F2(
					function (group, _v0) {
						var state = _v0.a;
						var acc = _v0.b;
						var corrected = A3($author$project$Main$correctGroupPlayers, players, state, group);
						var newState = A2($author$project$Main$applyGroupToInstances, corrected, state);
						return _Utils_Tuple2(
							newState,
							A2($elm$core$List$cons, corrected, acc));
					}),
				_Utils_Tuple2($author$project$Main$emptyInstances, _List_Nil),
				A3($author$project$Main$collectAllGroups, replay, sectionIndex, groupIndex)).b);
	});
var $author$project$Main$emptyActive = {b: $elm$core$Maybe$Nothing, a: $elm$core$Maybe$Nothing};
var $author$project$Main$computeActive = F4(
	function (players, replay, sectionIndex, groupIndex) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (group, a) {
					return A3($author$project$Main$applyGroupToActive, players.a, a, group);
				}),
			$author$project$Main$emptyActive,
			A4($author$project$Main$collectAndCorrectGroups, players, replay, sectionIndex, groupIndex));
	});
		...
		return A2(
			...
			$elm$core$List$head(
				A2(
					...
					function (_v0) {
						var e = _v0.b;
						return _Utils_eq(e.d, player) && (_Utils_eq(e.ag, cardId) && _Utils_eq(e.aL, position));
					},
					A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, state))));
	});
...
var $author$project$Main$removeFirstById = F2(
	function (targetId, list) {
		if (!list.b) {
			...
			var c = list.a;
			var rest = list.b;
			return _Utils_eq(c.T, targetId) ? rest : A2(
				$elm$core$List$cons,
				c,
...
var $author$project$Main$applyActionToAttachments = F4(
	function (preInstances, postInstances, action, state) {
		switch (action.$) {
			case 13:
				var player = action.a.d;
				var item = action.a.cY;
				var target = action.a.a_;
				var position = action.a.aL;
				var maybeIid = function () {
					if (position === 1) {
						return A4($author$project$Main$nthBenchInstance, player, target.e.T, 0, postInstances);
					} else {
						return A3($author$project$Main$firstInstance, player, target.e.T, postInstances);
					}
				}();
				if (maybeIid.$ === 1) {
					return state;
						...
						return A3(
							...
							function (e) {
								return _Utils_update(
									e,
									{
										H: A2($elm$core$List$cons, item, e.H)
									});
							},
							state);
					} else {
			...
			case 16:
				...
				var maybeIid = A2(
					...
					A2(
						$elm$core$Dict$get,
						_Utils_Tuple2(pokemon.d, pokemon.e.T),
						preInstances.g));
				var _v4 = A2(
					$elm$core$Maybe$andThen,
					function (iid) {
				...
				if (!_v4.$) {
					...
					var _v5 = A4($author$project$Main$findEntryIndex, pokemon.d, pokemon.e.T, 0, state);
					if (!_v5.$) {
						var idx = _v5.a;
						return A2(removeIdx, idx, state);
					} else {
						var _v6 = A4($author$project$Main$findEntryIndex, pokemon.d, pokemon.e.T, 1, state);
						if (!_v6.$) {
							var idx = _v6.a;
							return A2(removeIdx, idx, state);
						} else {
			...
			case 14:
				var player = action.a.d;
				var to = action.a.bn;
				var _v7 = A3($author$project$Main$firstInstance, player, to.T, postInstances);
				if (_v7.$ === 1) {
					return state;
				} else {
					var iid = _v7.a;
			...
			case 24:
				...
				var tryRemove = function (pos) {
					var _v11 = A4($author$project$Main$findEntryIndex, pokemon.d, pokemon.e.T, pos, state);
					if (!_v11.$) {
						var idx = _v11.a;
								...
								A3(
									...
									function (en) {
										return _Utils_update(
											en,
											{
												H: A2($author$project$Main$removeFirstById, card.T, en.H)
											});
									},
			...
			case 22:
				...
				var from = action.a.a7;
				var to = action.a.bn;
				return ($elm$core$String$isEmpty(to.T) ? $elm$core$Basics$identity : A4($author$project$Main$moveAttachments, player, to.T, 0, 1))(
					A5($author$project$Main$moveAttachments, player, from.T, 1, 0, state));
			case 20:
				var pokemon = action.a.t;
				var _v13 = A2(
					$elm$core$Maybe$andThen,
				...
				if (!_v13.$) {
					...
					var _v14 = A3($author$project$Main$firstInstance, pokemon.d, pokemon.e.T, postInstances);
					if (!_v14.$) {
						var iid = _v14.a;
						...
						return A5($author$project$Main$moveAttachments, pokemon.d, pokemon.e.T, 1, 0, state);
					}
				}
			case 21:
				var player = action.a.d;
				...
				if (!_v16.$) {
					...
					return A5($author$project$Main$moveAttachments, player, card.T, 0, 1, state);
				}
			default:
				return state;
		}
...
var $author$project$Main$applyGroupToAttachments = F4(
	function (preInstances, postInstances, group, state) {
		var state1 = A4($author$project$Main$applyActionToAttachments, preInstances, postInstances, group.R, state);
		return A3(
			$elm$core$List$foldl,
			F2(
				function (detail, s) {
					var s1 = A4($author$project$Main$applyActionToAttachments, preInstances, postInstances, detail.R, s);
					var s2 = A3(
						$elm$core$List$foldl,
						F2(
							function (bullet, bs) {
								return A4($author$project$Main$applyActionToAttachments, preInstances, postInstances, bullet.R, bs);
							}),
						s1,
						detail.az);
					var _v0 = detail.R;
								...
								function (bullet, bs) {
									return A3(
										...
										A2(
											...
											A2($elm$core$String$split, ', ', bullet.X)));
								}),
							s2,
							detail.az);
					} else {
...
var $author$project$Main$computeAttachments = F4(
	function (players, replay, sectionIndex, groupIndex) {
		...
		return A3(
			...
			F2(
				function (group, _v0) {
					...
					return _Utils_Tuple2(
						newInst,
						A4($author$project$Main$applyGroupToAttachments, inst, newInst, group, atts));
				}),
			_Utils_Tuple2($author$project$Main$emptyInstances, $author$project$Main$emptyAttachments),
			groups).b;
	});
	...
	function (red, player, cardId, bench) {
		var removeFirst = function (list) {
			if (!list.b) {
				...
				var x = list.a;
				var rest = list.b;
				return _Utils_eq(x.T, cardId) ? rest : A2(
					$elm$core$List$cons,
					x,
					removeFirst(rest));
			}
		...
		return _Utils_eq(player, red) ? _Utils_update(
			bench,
			{
				a: removeFirst(bench.a)
			}) : _Utils_update(
			bench,
			{
				b: removeFirst(bench.b)
			});
	});
	...
	function (red, player, fromId, to, bench) {
		var replaceFirst = function (list) {
			if (!list.b) {
				...
				var x = list.a;
				var rest = list.b;
				return _Utils_eq(x.T, fromId) ? A2($elm$core$List$cons, to, rest) : A2(
					$elm$core$List$cons,
					x,
					replaceFirst(rest));
			}
		...
		return _Utils_eq(player, red) ? _Utils_update(
			bench,
			{
				a: replaceFirst(bench.a)
			}) : _Utils_update(
			bench,
			{
				b: replaceFirst(bench.b)
			});
	});
var $author$project$Main$prependToBench = F4(
	function (red, player, card, bench) {
		return _Utils_eq(player, red) ? _Utils_update(
			bench,
			{
				a: A2($elm$core$List$cons, card, bench.a)
			}) : _Utils_update(
			bench,
			{
				b: A2($elm$core$List$cons, card, bench.b)
			});
	});
	...
	function (red, active, action, bench) {
		switch (action.$) {
			...
			case 14:
				...
				var position = action.a.aL;
				if (position === 1) {
					return A5($author$project$Main$replaceOnBench, red, player, from.T, to, bench);
				} else {
					return bench;
				}
			case 16:
				...
				var isActive = _Utils_eq(
					$elm$core$Maybe$Just(pokemon.e.T),
					A2(
						$elm$core$Maybe$map,
						function ($) {
							return $.T;
						},
						_Utils_eq(pokemon.d, red) ? active.a : active.b));
				return isActive ? bench : A4($author$project$Main$removeFromBench, red, pokemon.d, pokemon.e.T, bench);
			case 20:
				var pokemon = action.a.t;
				var alreadyActive = _Utils_eq(
					...
					A2(
						...
						_Utils_eq(pokemon.d, red) ? active.a : active.b));
				return alreadyActive ? bench : A4($author$project$Main$removeFromBench, red, pokemon.d, pokemon.e.T, bench);
			case 21:
				var player = action.a.d;
				var card = action.a.e;
			...
			case 22:
				...
				var from = action.a.a7;
				var to = action.a.bn;
				return ($elm$core$String$isEmpty(to.T) ? $elm$core$Basics$identity : A3($author$project$Main$retreatToBench, red, player, to))(
					A4($author$project$Main$removeFromBench, red, player, from.T, bench));
			default:
				return bench;
		}
	});
var $author$project$Main$pokemonAbilityPlayedCardId = function (group) {
	...
	switch (_v0.$) {
		case 8:
			var card = _v0.a.e;
			return $elm$core$Maybe$Just(card.T);
		case 15:
			var attacker = _v0.a.a2;
			return $elm$core$Maybe$Just(attacker.e.T);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$isPokemonAbilityGroup = function (group) {
	...
	if (_v0.$ === 1) {
		...
		var orderIsAbility = function () {
			var _v3 = group.R;
			if (_v3.$ === 8) {
				var indexed = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, group.bC);
		...
		var hasMatchingShuffleBack = A2(
			...
			function (d) {
				...
				if (_v1.$ === 31) {
					var info = _v1.a;
					return _Utils_eq(info.e, $elm$core$Maybe$Nothing) && A2(
						$elm$core$List$any,
						function (b) {
							var _v2 = b.R;
							if (_v2.$ === 48) {
...
var $author$project$Main$applyGroupToBench = F4(
	function (red, active, bench, group) {
		...
		var bench1 = A4($author$project$Main$applyActionToBench, red, active, group.R, bench);
		return A3(
			$elm$core$List$foldl,
			F2(
				function (detail, b) {
						...
						switch (_v0.$) {
							...
							case 31:
								...
								if (!pokemonAbilityCardId.$) {
									...
									return A4($author$project$Main$applyActionToBench, red, active, detail.R, b);
								}
							default:
								return A4($author$project$Main$applyActionToBench, red, active, detail.R, b);
						}
					...
					return A3(
						...
						F2(
							function (bullet, bb) {
								return A4($author$project$Main$applyActionToBench, red, active, bullet.R, bb);
							}),
						b1,
						detail.az);
				}),
...
var $author$project$Main$emptyBench = {b: _List_Nil, a: _List_Nil};
var $author$project$Main$computeBench = F4(
	function (players, replay, sectionIndex, groupIndex) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (group, _v0) {
					...
					var a = _v0.b;
					return _Utils_Tuple2(
						A4($author$project$Main$applyGroupToBench, players.a, a, b, group),
						A3($author$project$Main$applyGroupToActive, players.a, a, group));
				}),
			_Utils_Tuple2($author$project$Main$emptyBench, $author$project$Main$emptyActive),
			A4($author$project$Main$collectAndCorrectGroups, players, replay, sectionIndex, groupIndex)).a;
	});
...
var $author$project$Main$addKnownCards = F4(
	function (red, player, cards, hand) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (c, h) {
...
var $author$project$Main$addUnknowns = F4(
	function (red, player, n, hand) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (_v0, h) {
					return A4($author$project$Main$addCard, red, player, $elm$core$Maybe$Nothing, h);
				}),
			hand,
...
var $author$project$Main$cardIsInHand = F4(
	function (red, player, cardId, hand) {
		var playerHand = _Utils_eq(player, red) ? hand.a : hand.b;
		return A2(
			$elm$core$List$any,
			function (slot) {
				if (!slot.$) {
	...
	function (red, player, cardId, hand) {
		...
		var remove = function (list) {
			if (!list.b) {
				...
				if (!x.$) {
					var c = x.a;
					return _Utils_eq(c.T, cardId) ? rest : A2(
						$elm$core$List$cons,
						x,
						remove(rest));
				} else {
		...
		var attempt = function (list) {
			var reduced = remove(list);
			return (_Utils_cmp(
				$elm$core$List$length(reduced),
				$elm$core$List$length(list)) < 0) ? reduced : removeFallback(list);
		};
		return _Utils_eq(player, red) ? _Utils_update(
			hand,
			{
...
var $author$project$Main$removeN = F4(
	function (red, player, n, hand) {
		var dropLast = F2(
			function (count, list) {
				return A2(
					...
					A2(
						$elm$core$Basics$max,
						0,
						$elm$core$List$length(list) - count),
					list);
			});
		return _Utils_eq(player, red) ? _Utils_update(
			hand,
			{
				a: A2(dropLast, n, hand.a)
			}) : _Utils_update(
			hand,
			{
				b: A2(dropLast, n, hand.b)
			});
	});
var $author$project$Main$applyDetailAction = F3(
	function (red, hand, detail) {
		var _v0 = detail.R;
		switch (_v0.$) {
			case 10:
				var player = _v0.a.d;
				...
				return $elm$core$List$isEmpty(known) ? A4($author$project$Main$addUnknowns, red, player, count, hand) : A4($author$project$Main$addKnownCards, red, player, known, hand);
			case 9:
				var player = _v0.a.d;
				var card = _v0.a.e;
				return A4($author$project$Main$addCard, red, player, card, hand);
			case 11:
				var player = _v0.a.d;
				var card = _v0.a.e;
				var andPlayed = _v0.a.cw;
				if (andPlayed.$ === 1) {
					return A4(
						$author$project$Main$addCard,
						red,
			...
			case 27:
				...
				if (!card.$) {
					...
					return A4(
						$author$project$Main$addUnknowns,
						red,
						player,
			...
			case 13:
				var player = _v0.a.d;
				var item = _v0.a.cY;
				return A4($author$project$Main$removeById, red, player, item.T, hand);
			case 35:
				var player = _v0.a.d;
				var card = _v0.a.e;
				return A4($author$project$Main$cardIsInHand, red, player, card.T, hand) ? A4($author$project$Main$removeById, red, player, card.T, hand) : hand;
			case 34:
				var player = _v0.a.d;
				var count = _v0.a.l;
				var known = $author$project$Main$detailCardList(detail);
				return $elm$core$List$isEmpty(known) ? A4($author$project$Main$removeN, red, player, count, hand) : A3(
					...
					F2(
						function (card, h) {
							return A4($author$project$Main$removeById, red, player, card.T, h);
						}),
					hand,
					known);
			case 31:
				...
				if (!card.$) {
					var c = card.a;
					return A4($author$project$Main$removeById, red, player, c.T, hand);
				} else {
					var known = $author$project$Main$detailCardList(detail);
					return $elm$core$List$isEmpty(known) ? A4(
						...
						F2(
							function (c, h) {
								return A4($author$project$Main$removeById, red, player, c.T, h);
							}),
						hand,
						known);
				}
			case 29:
				var player = _v0.a.d;
				var card = _v0.a.e;
				return A4($author$project$Main$removeById, red, player, card.T, hand);
			case 30:
				var player = _v0.a.d;
				var card = _v0.a.e;
				var count = _v0.a.l;
			...
			case 14:
				var player = _v0.a.d;
				var to = _v0.a.bn;
				return A4($author$project$Main$removeById, red, player, to.T, hand);
			case 28:
				var owner = _v0.a.dg;
				var count = _v0.a.l;
				var known = $author$project$Main$detailCardList(detail);
				return $elm$core$List$isEmpty(known) ? A4($author$project$Main$removeN, red, owner, count, hand) : A3(
					...
					F2(
						function (card, h) {
							return A4($author$project$Main$removeById, red, owner, card.T, h);
						}),
					hand,
					known);
			default:
...
var $author$project$Main$setHand = F4(
	function (red, player, cards, hand) {
		return _Utils_eq(player, red) ? _Utils_update(
			hand,
			{a: cards}) : _Utils_update(
			hand,
			{b: cards});
	});
var $author$project$Main$applyTopAction = F3(
	function (red, hand, group) {
		...
		switch (_v0.$) {
			case 3:
				var player = _v0.a.d;
				var count = _v0.a.l;
				var known = $author$project$Main$bulletCardList(group);
				return $elm$core$List$isEmpty(known) ? A4($author$project$Main$addUnknowns, red, player, count, hand) : A4(
					$author$project$Main$setHand,
					red,
					player,
					A2($elm$core$List$map, $elm$core$Maybe$Just, known),
					hand);
			case 4:
				var player = _v0.a.d;
				return A4(
...
var $author$project$Main$isDiscardShuffleGroup = function (group) {
	...
	if (_v0.$ === 8) {
		var card = _v0.a.e;
		return card.aI === 'Energy Recycler';
	} else {
		return false;
	}
};
...
var $author$project$Main$emptyHand = {b: _List_Nil, a: _List_Nil};
var $author$project$Main$computeHand = F4(
	function (players, replay, sectionIndex, groupIndex) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (group, h) {
					return A3($author$project$Main$applyGroupToHand, players.a, h, group);
				}),
			$author$project$Main$emptyHand,
			A4($author$project$Main$collectAndCorrectGroups, players, replay, sectionIndex, groupIndex));
	});
var $author$project$Main$applyGroupToStadium = F2(
	function (stadium, group) {
		var applyAction = F2(
			function (action, st) {
				if (action.$ === 7) {
					var player = action.a.d;
			...
			F2(
				function (detail, st) {
					return A3(
						...
						F2(
							function (bullet, bs) {
								return A2(applyAction, bullet.R, bs);
							}),
						A2(applyAction, detail.R, st),
						detail.az);
				}),
			A2(applyAction, group.R, stadium),
			group.bC);
	});
var $author$project$Main$computeStadium = F4(
	function (players, replay, sectionIndex, groupIndex) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (group, st) {
					return A2($author$project$Main$applyGroupToStadium, st, group);
				}),
			$elm$core$Maybe$Nothing,
			A4($author$project$Main$collectAndCorrectGroups, players, replay, sectionIndex, groupIndex));
	});
var $author$project$Main$emptyPlayerCards = {M: _List_Nil, E: _List_Nil, K: _List_Nil, ad: _List_Nil};
var $author$project$Main$currentPlayFromGroup = F2(
	function (players, group) {
		...
		switch (_v0.$) {
			case 8:
				var player = _v0.a.d;
				var card = _v0.a.e;
				var extractShuffled = function (ds) {
					return A2(
						$elm$core$List$concatMap,
						function (d) {
							var _v10 = d.R;
							if (_v10.$ === 31) {
								var shuffleData = _v10.a;
								var _v11 = shuffleData.e;
								if (!_v11.$) {
									var c = _v11.a;
									return _List_fromArray(
										[
									...
									var known = $author$project$Main$detailCardList(d);
									return $elm$core$List$isEmpty(known) ? A2(
										$elm$core$List$repeat,
										A2($elm$core$Maybe$withDefault, 1, shuffleData.l),
										$elm$core$Maybe$Nothing) : A2($elm$core$List$map, $elm$core$Maybe$Just, known);
								}
							} else {
								return _List_Nil;
							}
						...
						function (d) {
							...
							switch (_v7.$) {
								case 10:
									var drewData = _v7.a;
									var known = $author$project$Main$detailCardList(d);
									return $elm$core$List$isEmpty(known) ? A2($elm$core$List$repeat, drewData.l, $elm$core$Maybe$Nothing) : A2($elm$core$List$map, $elm$core$Maybe$Just, known);
								case 9:
									var drewData = _v7.a;
									return _List_fromArray(
										[drewData.e]);
								case 11:
									var drewCardData = _v7.a;
									var _v8 = drewCardData.cw;
									if (_v8.$ === 1) {
										return _List_fromArray(
											[
												$elm$core$Maybe$Just(drewCardData.e)
											]);
									} else {
										return _List_Nil;
									}
								case 27:
									...
									if (!_v9.$) {
										...
										return A2(
											$elm$core$List$repeat,
											A2($elm$core$Maybe$withDefault, 1, movedData.l),
											$elm$core$Maybe$Nothing);
									}
								default:
									return _List_Nil;
				...
				var extractDiscards = function (ds) {
					return A2(
						$elm$core$List$concatMap,
						function (d) {
							var _v6 = d.R;
							switch (_v6.$) {
								case 35:
									var discardData = _v6.a;
									return _List_fromArray(
										[
											$elm$core$Maybe$Just(discardData.e)
										]);
								case 34:
									var discardData = _v6.a;
									var known = $author$project$Main$detailCardList(d);
									return $elm$core$List$isEmpty(known) ? A2($elm$core$List$repeat, discardData.l, $elm$core$Maybe$Nothing) : A2($elm$core$List$map, $elm$core$Maybe$Just, known);
								default:
									return _List_Nil;
							}
						},
				...
				var extractBenched = function (ds) {
					return A2(
						$elm$core$List$concatMap,
						function (d) {
							var _v2 = d.R;
							switch (_v2.$) {
								case 11:
									var drewCardBench = _v2.a;
									var _v3 = drewCardBench.cw;
									if ((!_v3.$) && (_v3.a === 1)) {
										var _v4 = _v3.a;
										return _List_fromArray(
											[
												$elm$core$Maybe$Just(drewCardBench.e)
											]);
									} else {
										return _List_Nil;
									}
								case 12:
									var count = _v2.a.l;
									var position = _v2.a.aL;
									if (position === 1) {
										var known = $author$project$Main$detailCardList(d);
										return $elm$core$List$isEmpty(known) ? A2($elm$core$List$repeat, count, $elm$core$Maybe$Nothing) : A2($elm$core$List$map, $elm$core$Maybe$Just, known);
									} else {
										return _List_Nil;
									}
								default:
				...
				var detailOwner = function (d) {
					var _v1 = d.R;
					switch (_v1.$) {
						case 35:
							var rec = _v1.a;
							return $elm$core$Maybe$Just(rec.d);
						case 34:
							var rec = _v1.a;
							return $elm$core$Maybe$Just(rec.d);
						case 31:
				...
				var correctedDetails = A3($author$project$Main$correctGroupPlayers, players, $author$project$Main$emptyInstances, group).bC;
				var detailsFor = function (p) {
					return A2(
						$elm$core$List$filter,
						function (d) {
							return _Utils_eq(
				...
				var makePlayerCards = function (p) {
					var ds = detailsFor(p);
					return {
						M: extractBenched(ds),
						E: extractDiscards(ds),
						K: extractDrawn(ds),
						ad: extractShuffled(ds)
					};
				};
				return $elm$core$Maybe$Just(
					{
						b: makePlayerCards(players.b),
						e: $elm$core$Maybe$Just(card),
						d: player,
						a: makePlayerCards(players.a)
					});
			case 36:
				var player = _v0.a.d;
				var drawnCards = A2(
					...
					group.bC);
				var playerCards = {M: _List_Nil, E: _List_Nil, K: drawnCards, ad: _List_Nil};
				return $elm$core$List$isEmpty(drawnCards) ? $elm$core$Maybe$Nothing : (_Utils_eq(player, players.a) ? $elm$core$Maybe$Just(
					{b: $author$project$Main$emptyPlayerCards, e: $elm$core$Maybe$Nothing, d: player, a: playerCards}) : $elm$core$Maybe$Just(
					{b: playerCards, e: $elm$core$Maybe$Nothing, d: player, a: $author$project$Main$emptyPlayerCards}));
			case 15:
				var attacker = _v0.a.a2;
				var extractDiscards = function (ds) {
					return A2(
				...
				var correctedDetails = A3($author$project$Main$correctGroupPlayers, players, $author$project$Main$emptyInstances, group).bC;
				var discardedFor = function (p) {
					return extractDiscards(
						A2(
							$elm$core$List$filter,
							function (d) {
								var _v13 = d.R;
				...
				var redCards = {
					M: _List_Nil,
					E: discardedFor(players.a),
					K: _List_Nil,
					ad: _List_Nil
				};
				var blueCards = {
					M: _List_Nil,
					E: discardedFor(players.b),
					K: _List_Nil,
					ad: _List_Nil
				};
				return ($elm$core$List$isEmpty(redCards.E) && $elm$core$List$isEmpty(blueCards.E)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
					{b: blueCards, e: $elm$core$Maybe$Nothing, d: attacker.d, a: redCards});
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
var $author$project$Main$getCurrentGroup = F3(
	function (replay, si, gi) {
		return A2(
			$elm$core$Maybe$andThen,
			A2(
				$elm$core$Basics$composeR,
				$elm$core$List$drop(gi),
				$elm$core$List$head),
			A2(
				$elm$core$Maybe$map,
				A2($elm$core$Basics$composeR, $author$project$Main$sectionLines, $author$project$Action$groupLines),
				$elm$core$List$head(
					A2($elm$core$List$drop, si, replay.y))));
	});
...
var $author$project$Main$fetchHandCards = F5(
	function (maybePlayers, replay, si, gi, cache) {
		if (maybePlayers.$ === 1) {
			return $elm$core$Platform$Cmd$none;
		} else {
			var players = maybePlayers.a;
			var stadiumRef = A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2(
					...
					A2(
						...
						A4($author$project$Main$computeStadium, players, replay, si, gi))));
			var playRefs = A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2(
					$elm$core$Maybe$map,
					function (play) {
						var allCards = function (pc) {
							return _Utils_ap(
								A2($elm$core$List$filterMap, $elm$core$Basics$identity, pc.E),
								_Utils_ap(
									A2($elm$core$List$filterMap, $elm$core$Basics$identity, pc.ad),
									_Utils_ap(
										A2($elm$core$List$filterMap, $elm$core$Basics$identity, pc.K),
										A2($elm$core$List$filterMap, $elm$core$Basics$identity, pc.M))));
						};
						return _Utils_ap(
							function () {
								var _v1 = play.e;
					...
					A2(
						$elm$core$Maybe$andThen,
						$author$project$Main$currentPlayFromGroup(players),
						A3($author$project$Main$getCurrentGroup, replay, si, gi))));
			var hand = A4($author$project$Main$computeHand, players, replay, si, gi);
			var handRefs = _Utils_ap(
				A2($elm$core$List$filterMap, $elm$core$Basics$identity, hand.a),
				A2($elm$core$List$filterMap, $elm$core$Basics$identity, hand.b));
			var bench = A4($author$project$Main$computeBench, players, replay, si, gi);
			var benchRefs = _Utils_ap(bench.a, bench.b);
			var attachmentRefs = A2(
				$elm$core$List$concatMap,
				function ($) {
					return $.H;
				},
				A4($author$project$Main$computeAttachments, players, replay, si, gi));
			var activeSpots = A4($author$project$Main$computeActive, players, replay, si, gi);
			var activeRefs = A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
					[activeSpots.a, activeSpots.b]));
			var knownIds = A2(
				$elm$core$List$filter,
				function (id) {
				...
				A3(
					...
					F2(
						function (id, acc) {
							return A2($elm$core$List$member, id, acc) ? acc : A2($elm$core$List$cons, id, acc);
						}),
					_List_Nil,
					A2(
						$elm$core$List$map,
						...
						_Utils_ap(
							...
							_Utils_ap(
								...
								_Utils_ap(
									...
									_Utils_ap(
										stadiumRef,
										_Utils_ap(attachmentRefs, playRefs))))))));
						...
						return A2(
							...
							function (apiUrl) {
								return $elm$http$Http$get(
									{
										ah: $elm$http$Http$expectString(
											$author$project$Main$GotCardImage(id)),
										u: apiUrl
									});
							},
							$author$project$Main$cardApiUrl(id));
					},
					knownIds));
		}
	});
var $author$project$Main$httpErrorToString = function (err) {
	switch (err.$) {
		...
		case 3:
			if (err.a === 404) {
				return 'No replay content found — check the URL';
			} else {
				var status = err.a;
...
var $author$project$Replay$emptyState = {ap: $elm$core$Maybe$Nothing, _: _List_Nil, y: _List_Nil, at: 0};
var $author$project$Replay$ResultSection = function (a) {
	return {$: 3, a: a};
};
var $author$project$Replay$TurnSection = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Replay$parseMatchResult = function (text) {
	if (A2($elm$core$String$endsWith, ' wins.', text)) {
		...
		var words = $elm$core$String$words(withoutWins);
...
var $author$project$Replay$CheckupSection = function (a) {
	return {$: 2, a: a};
};
var $author$project$Replay$SetupSection = function (a) {
	return {$: 0, a: a};
};
var $author$project$Replay$buildSection = F2(
	function (kind, lines) {
		switch (kind.$) {
			case 0:
				return $author$project$Replay$SetupSection(lines);
			case 1:
				var turn = kind.a;
				return A2($author$project$Replay$TurnSection, turn, lines);
			default:
				return $author$project$Replay$CheckupSection(lines);
		}
	});
var $author$project$Replay$finalizeSections = function (state) {
	var _v0 = state.ap;
	if (_v0.$ === 1) {
		return state.y;
	} else {
		...
		return _Utils_ap(
			...
			_List_fromArray(
				[
					A2(
					$author$project$Replay$buildSection,
					kind,
					$elm$core$List$reverse(state._))
				]));
	}
};
var $author$project$Replay$identifyRedPlayer = F2(
	function (drawSuffix, lines) {
		var suffixLen = $elm$core$String$length(drawSuffix);
		var step = F2(
			function (line, _v3) {
				var waitingFor = _v3.a;
				var found = _v3.b;
				if (!found.$) {
					return _Utils_Tuple2(waitingFor, found);
				} else {
					switch (line.$) {
						case 0:
							var text = line.a;
							return A2($elm$core$String$endsWith, drawSuffix, text) ? _Utils_Tuple2(
								$elm$core$Maybe$Just(
									A2($elm$core$String$dropRight, suffixLen, text)),
								$elm$core$Maybe$Nothing) : _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing);
						case 2:
							if (!waitingFor.$) {
								var player = waitingFor.a;
								return _Utils_Tuple2(
									$elm$core$Maybe$Nothing,
						...
						default:
							return _Utils_Tuple2(waitingFor, $elm$core$Maybe$Nothing);
					}
				}
			});
		return A3(
...
var $author$project$Replay$identifyPlayers = function (sections) {
	if (sections.b && (!sections.a.$)) {
		var lines = sections.a.a;
		var drawSuffix = ' drew 7 cards for the opening hand.';
		var drewPlayers = A2(
			$elm$core$List$filterMap,
			function (line) {
				if (!line.$) {
					var text = line.a;
					return A2($elm$core$String$endsWith, drawSuffix, text) ? $elm$core$Maybe$Just(
						A2(
							$elm$core$String$dropRight,
							$elm$core$String$length(drawSuffix),
		...
		var _v1 = _Utils_Tuple2(
			A2($author$project$Replay$identifyRedPlayer, drawSuffix, lines),
			drewPlayers);
		if (((!_v1.a.$) && _v1.b.b) && _v1.b.b.b) {
			var red = _v1.a.a;
			var _v2 = _v1.b;
			var p1 = _v2.a;
			var _v3 = _v2.b;
...
var $author$project$Replay$KindCheckup = {$: 2};
var $author$project$Replay$KindSetup = {$: 0};
var $author$project$Replay$KindTurn = function (a) {
	return {$: 1, a: a};
};
var $author$project$Replay$BulletLine = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Replay$classifyLine = function (line) {
	return A2($elm$core$String$startsWith, '   •', line) ? $author$project$Replay$BulletLine(
		$elm$core$String$trim(
			A2($elm$core$String$dropLeft, 4, line))) : (A2($elm$core$String$startsWith, '- ', line) ? $author$project$Replay$DetailLine(
		A2($elm$core$String$dropLeft, 2, line)) : $author$project$Replay$TopLine(line));
};
var $author$project$Replay$commitSection = function (state) {
	var _v0 = state.ap;
	if (_v0.$ === 1) {
		return state.y;
	} else {
...
var $author$project$Replay$parseTurnHeader = function (line) {
	if (A2($elm$core$String$startsWith, 'Turn # ', line)) {
		...
		if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
			var turnPart = _v0.a;
			var _v1 = _v0.b;
			var playerPart = _v1.a;
			return A2(
				$elm$core$Maybe$map,
				function (n) {
					return {
						bb: $elm$core$Maybe$Just(n),
						d: A2($elm$core$String$dropRight, 7, playerPart)
					};
				},
				$elm$core$String$toInt(
					A2($elm$core$String$dropLeft, 7, turnPart)));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	} else {
			...
			return $elm$core$Maybe$Just(
				{
					...
					d: A2($elm$core$String$dropRight, 7, line)
				});
		} else {
			return $elm$core$Maybe$Nothing;
		}
...
var $author$project$Replay$startSection = F2(
	function (kind, state) {
		return {
			ap: $elm$core$Maybe$Just(kind),
			_: _List_Nil,
			y: $author$project$Replay$commitSection(state),
			at: state.at
		};
	});
var $author$project$Replay$processLine = F2(
	function (line, state) {
		if (line === 'Setup') {
			return A2($author$project$Replay$startSection, $author$project$Replay$KindSetup, state);
		} else {
			if (line === 'Pokémon Checkup') {
				return A2($author$project$Replay$startSection, $author$project$Replay$KindCheckup, state);
			} else {
				var _v0 = $author$project$Replay$parseTurnHeader(line);
				if (!_v0.$) {
					var player = _v0.a.d;
					var maybeNumber = _v0.a.bb;
					var newCount = state.at + 1;
					var turn = {
						b_: A2($elm$core$Maybe$withDefault, newCount, maybeNumber),
						d: player
					};
					return {
						ap: $elm$core$Maybe$Just(
							$author$project$Replay$KindTurn(turn)),
						_: _List_Nil,
						y: $author$project$Replay$commitSection(state),
						at: newCount
					};
					...
					return $elm$core$String$isEmpty(
						$elm$core$String$trim(line)) ? state : _Utils_update(
						state,
						{
							_: A2(
								$elm$core$List$cons,
								$author$project$Replay$classifyLine(line),
								state._)
						});
				}
			}
...
var $author$project$Replay$parse = function (raw) {
	var sections = $author$project$Replay$extractResult(
		$author$project$Replay$finalizeSections(
			A3(
				$elm$core$List$foldl,
				$author$project$Replay$processLine,
				$author$project$Replay$emptyState,
				A2(
					$elm$core$List$map,
					A2($elm$core$String$replace, '\u000D', ''),
					$elm$core$String$lines(raw)))));
	return {
		W: $author$project$Replay$identifyPlayers(sections),
		y: sections
	};
};
...
var $author$project$Main$pushUrl = _Platform_outgoingPort(
	'pushUrl',
	function ($) {
...
var $author$project$Main$sectionGroupCount = function (section) {
	switch (section.$) {
		case 0:
			var lines = section.a;
			return $elm$core$List$length(
				$author$project$Action$groupLines(lines));
		case 1:
			var lines = section.b;
			return $elm$core$List$length(
				$author$project$Action$groupLines(lines));
...
var $author$project$Main$loadReplay = F5(
	function (url, requestedIndex, requestedGroupIndex, ctx, content) {
		var normalized = A3($elm$core$String$replace, '\u2019', '\'', content);
		var replay = $author$project$Replay$parse(normalized);
		var index = A2(
			$elm$core$Basics$min,
			A2($elm$core$Basics$max, 0, requestedIndex),
			A2(
				$elm$core$Basics$max,
				0,
				$elm$core$List$length(replay.y) - 1));
		var groupIndex = function () {
			var section = $elm$core$List$head(
				A2($elm$core$List$drop, index, replay.y));
			var maxGroup = function (n) {
				return A2($elm$core$Basics$max, 0, n - 1);
			}(
				A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm$core$Maybe$map, $author$project$Main$sectionGroupCount, section)));
			return A2(
				$elm$core$Basics$min,
				A2($elm$core$Basics$max, 0, requestedGroupIndex),
				maxGroup);
		}();
		return $elm$core$List$isEmpty(replay.y) ? _Utils_Tuple2(
			A2($author$project$Main$Failed, url, 'No replay content found — check the URL'),
			$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
			A7($author$project$Main$Loaded, url, replay, index, groupIndex, $elm$core$Maybe$Nothing, $elm$core$Dict$empty, ctx),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$pushUrl(
						{h: ctx.h, B: groupIndex, U: index, u: url}),
						A5($author$project$Main$fetchHandCards, replay.W, replay, index, groupIndex, $elm$core$Dict$empty)
					])));
	});
...
var $author$project$Main$scrollToTop = A2(
	...
	A3($elm$browser$Browser$Dom$setViewportOf, 'action-content', 0, 0));
		...
		while (true) {
			switch (msg.$) {
				...
				case 1:
					...
					var debug = $author$project$Main$currentDebug(model);
					if ($elm$core$String$isEmpty(url)) {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						var ctx = {S: debug, h: flip};
						var _v1 = $author$project$Main$trainingCourtLogId(url);
						if (!_v1.$) {
							var uuid = _v1.a;
							return _Utils_Tuple2(
								A4($author$project$Main$Loading, url, 0, 0, ctx),
								A4($author$project$Main$fetchTrainingCourtLog, uuid, 0, 0, flip));
						} else {
							return _Utils_Tuple2(
								A4($author$project$Main$Loading, url, 0, 0, ctx),
								$elm$http$Http$get(
					...
					switch (model.$) {
						case 1:
							...
							if (!result.$) {
								...
								return A5($author$project$Main$loadReplay, url, idx, gIdx, ctx, content);
							} else {
								if (result.a.$ === 2) {
									var _v4 = result.a;
									return _Utils_Tuple2(
										A4($author$project$Main$Retrying, url, idx, gIdx, ctx),
										$elm$http$Http$get(
											{
												ah: $elm$http$Http$expectString($author$project$Main$GotReplay),
												u: $author$project$Main$proxyUrl(url)
											}));
								} else {
									var err = result.a;
									return _Utils_Tuple2(
				...
				case 4:
					if (model.$ === 3) {
						...
						var ctx = model.g;
						return _Utils_Tuple2(
							A7($author$project$Main$Loaded, url, replay, 0, 0, $elm$core$Maybe$Nothing, cache, ctx),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Main$pushUrl(
										{h: ctx.h, B: 0, U: 0, u: url}),
										$author$project$Main$scrollToTop,
										A5($author$project$Main$fetchHandCards, replay.W, replay, 0, 0, cache)
									])));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 5:
					if (model.$ === 3) {
						...
						if (g > 0) {
							return _Utils_Tuple2(
								A7($author$project$Main$Loaded, url, replay, i, g - 1, $elm$core$Maybe$Nothing, cache, ctx),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Main$pushUrl(
											{h: ctx.h, B: g - 1, U: i, u: url}),
											$author$project$Main$scrollToTop,
											A5($author$project$Main$fetchHandCards, replay.W, replay, i, g - 1, cache)
										])));
						} else {
							if (i > 0) {
								var newI = i - 1;
								var prevSection = $elm$core$List$head(
									A2($elm$core$List$drop, newI, replay.y));
								var prevCount = A2(
									$elm$core$Maybe$withDefault,
									1,
									A2($elm$core$Maybe$map, $author$project$Main$sectionGroupCount, prevSection));
								var newG = A2($elm$core$Basics$max, 0, prevCount - 1);
								return _Utils_Tuple2(
									A7($author$project$Main$Loaded, url, replay, newI, newG, $elm$core$Maybe$Nothing, cache, ctx),
									$elm$core$Platform$Cmd$batch(
										_List_fromArray(
											[
												$author$project$Main$pushUrl(
												{h: ctx.h, B: newG, U: newI, u: url}),
												$author$project$Main$scrollToTop,
												A5($author$project$Main$fetchHandCards, replay.W, replay, newI, newG, cache)
											])));
							} else {
								return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
							}
				...
				case 6:
					if (model.$ === 3) {
						...
						var cache = model.f;
						var ctx = model.g;
						var totalSections = $elm$core$List$length(replay.y);
						var currentSection = $elm$core$List$head(
							A2($elm$core$List$drop, i, replay.y));
						var totalGroups = A2(
							$elm$core$Maybe$withDefault,
							1,
							A2($elm$core$Maybe$map, $author$project$Main$sectionGroupCount, currentSection));
						return (_Utils_cmp(g, totalGroups - 1) < 0) ? _Utils_Tuple2(
							A7($author$project$Main$Loaded, url, replay, i, g + 1, $elm$core$Maybe$Nothing, cache, ctx),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										$author$project$Main$scrollToTop,
										A5($author$project$Main$fetchHandCards, replay.W, replay, i, g + 1, cache)
									]))) : ((_Utils_cmp(i, totalSections - 1) < 0) ? _Utils_Tuple2(
							A7($author$project$Main$Loaded, url, replay, i + 1, 0, $elm$core$Maybe$Nothing, cache, ctx),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Main$pushUrl(
										{h: ctx.h, B: 0, U: i + 1, u: url}),
										$author$project$Main$scrollToTop,
										A5($author$project$Main$fetchHandCards, replay.W, replay, i + 1, 0, cache)
				...
				case 7:
					if (model.$ === 3) {
						...
						var cache = model.f;
						var ctx = model.g;
						var lastI = $elm$core$List$length(replay.y) - 1;
						var lastSection = $elm$core$List$head(
							A2($elm$core$List$drop, lastI, replay.y));
						var lastCount = A2(
							$elm$core$Maybe$withDefault,
							1,
							A2($elm$core$Maybe$map, $author$project$Main$sectionGroupCount, lastSection));
						var lastG = A2($elm$core$Basics$max, 0, lastCount - 1);
						return _Utils_Tuple2(
							A7($author$project$Main$Loaded, url, replay, lastI, lastG, $elm$core$Maybe$Nothing, cache, ctx),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Main$pushUrl(
										{h: ctx.h, B: lastG, U: lastI, u: url}),
										$author$project$Main$scrollToTop,
										A5($author$project$Main$fetchHandCards, replay.W, replay, lastI, lastG, cache)
									])));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				...
				case 10:
					...
					if (model.$ === 3) {
						...
						var cache = model.f;
						var ctx = model.g;
						var _v15 = A2($elm$core$Dict$get, id, cache);
						if (!_v15.$) {
							var cardData = _v15.a;
							return _Utils_Tuple2(
								A7(
									...
									g,
									$elm$core$Maybe$Just(
										A2($author$project$Main$ShowingCard, id, cardData)),
									cache,
									ctx),
								$elm$core$Platform$Cmd$none);
						} else {
							var _v16 = $author$project$Main$cardApiUrl(id);
							if (!_v16.$) {
								var apiUrl = _v16.a;
								return _Utils_Tuple2(
									A7(
										...
										g,
										$elm$core$Maybe$Just(
											A2($author$project$Main$FetchingCard, id, fallbackName)),
										cache,
										ctx),
									$elm$http$Http$get(
										{
				...
				case 11:
					...
					if (model.$ === 3) {
						...
						var cache = model.f;
						var ctx = model.g;
						var _v18 = A2($elm$core$Dict$get, cardId, cache);
						if (!_v18.$) {
							var cardData = _v18.a;
							return _Utils_Tuple2(
								A7(
									...
									g,
									$elm$core$Maybe$Just(
										A2($author$project$Main$ShowingMove, cardData, moveName)),
									cache,
									ctx),
								$elm$core$Platform$Cmd$none);
						} else {
							var _v19 = $author$project$Main$cardApiUrl(cardId);
							if (!_v19.$) {
								var apiUrl = _v19.a;
								return _Utils_Tuple2(
									A7(
										...
										g,
										$elm$core$Maybe$Just(
											A2($author$project$Main$FetchingMove, cardId, moveName)),
										cache,
										ctx),
									$elm$http$Http$get(
										{
											ah: $elm$http$Http$expectString(
												$author$project$Main$GotCardImage(cardId)),
											u: apiUrl
										}));
							} else {
								return _Utils_Tuple2(
									A7(
										...
										g,
										$elm$core$Maybe$Just(
											$author$project$Main$CardNotFound(cardId)),
										cache,
										ctx),
									$elm$core$Platform$Cmd$none);
							}
				...
				case 13:
					...
					if (model.$ === 3) {
							...
							while (true) {
								if (!currentPopup.$) {
									switch (currentPopup.a.$) {
										case 0:
											var _v32 = currentPopup.a;
											var fetchId = _v32.a;
											return _Utils_eq(fetchId, id);
										case 1:
											var _v33 = currentPopup.a;
											return true;
										default:
											break _v31$2;
									}
						...
						var _v22 = function () {
							if (!result.$) {
								var body = result.a;
								var _v24 = $author$project$Main$decodeCardData(body);
								if (!_v24.$) {
									var cardData = _v24.a;
									var resolvedData = function () {
										var _v28 = cardData.ak;
										if (!_v28.$) {
											return cardData;
										} else {
											var _v29 = A2(
											...
											if (!_v29.$) {
												var apiName = _v29.a;
												var _v30 = $author$project$Main$basicEnergyImageUrl(apiName);
												if (!_v30.$) {
													var fallbackUrl = _v30.a;
													return _Utils_update(
														cardData,
														{
															ak: $elm$core$Maybe$Just(fallbackUrl)
														});
												} else {
													return cardData;
												}
									...
									return _Utils_Tuple2(
										popup,
										A3($elm$core$Dict$insert, id, resolvedData, cache));
								} else {
									return _Utils_Tuple2(
										isUserFetch ? $elm$core$Maybe$Just(
											$author$project$Main$CardNotFound(id)) : currentPopup,
										cache);
								}
							} else {
								return _Utils_Tuple2(
						...
						var nextPopup = _v22.a;
						var newCache = _v22.b;
						return _Utils_Tuple2(
							A7($author$project$Main$Loaded, url, replay, i, g, nextPopup, newCache, ctx),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 15:
					if (model.$ === 3) {
						...
						var ctx = model.g;
						return _Utils_Tuple2(
							A7($author$project$Main$Loaded, url, replay, i, g, $elm$core$Maybe$Nothing, cache, ctx),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
...
var $author$project$Main$addDamageHp = F3(
	function (key, amount, state) {
		var current = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Dict$get, key, state));
		var next = current + amount;
		return (next <= 0) ? A2($elm$core$Dict$remove, key, state) : A3($elm$core$Dict$insert, key, next, state);
	});
var $author$project$Main$applyGroupToDamage = F4(
	function (preInstances, postInstances, group, state) {
		var preventedIds = A2(
			$elm$core$List$filterMap,
			function (d) {
				var _v15 = d.R;
				if (_v15.$ === 41) {
					var pokemon = _v15.a.t;
					return $elm$core$Maybe$Just(pokemon.T);
				} else {
					return $elm$core$Maybe$Nothing;
				}
			},
		...
		var state1 = function () {
			...
			switch (_v8.$) {
				case 15:
					var target = _v8.a.a_;
					if (!target.$) {
						var defender = target.a.cL;
						var damage = target.a.cI;
						if (A2($elm$core$List$member, defender.e.T, preventedIds)) {
							return state;
						} else {
							var _v10 = A3($author$project$Main$firstInstance, defender.d, defender.e.T, postInstances);
							if (_v10.$ === 1) {
								return state;
							} else {
								var iid = _v10.a;
				...
				case 17:
					var pokemon = _v8.a.t;
					var amount = _v8.a.br;
					var _v11 = A3($author$project$Main$firstInstance, pokemon.d, pokemon.e.T, postInstances);
					if (_v11.$ === 1) {
						return state;
					} else {
						var iid = _v11.a;
				...
				case 37:
					var pokemon = _v8.a.t;
					var counters = _v8.a.cH;
					var _v12 = A3($author$project$Main$firstInstance, pokemon.d, pokemon.e.T, postInstances);
					if (_v12.$ === 1) {
						return state;
					} else {
						var iid = _v12.a;
				...
				case 16:
					var pokemon = _v8.a.t;
					var _v13 = A3($author$project$Main$firstInstance, pokemon.d, pokemon.e.T, preInstances);
					if (_v13.$ === 1) {
						return state;
					} else {
						var iid = _v13.a;
		...
		var state2 = A3(
				...
				function (detail, _v0) {
					...
					switch (_v1.$) {
						case 17:
							...
							var key = _Utils_Tuple2(pokemon.d, pokemon.e.T);
							var n = ordinal(key);
							var _v2 = A4($author$project$Main$nthInstance, pokemon.d, pokemon.e.T, n, postInstances);
							if (_v2.$ === 1) {
								return _Utils_Tuple2(
									s,
									bump(key));
						...
						case 38:
							...
							var key = _Utils_Tuple2(pokemon.d, pokemon.e.T);
							var n = ordinal(key);
							var _v3 = A4($author$project$Main$nthBenchInstance, pokemon.d, pokemon.e.T, n, postInstances);
							if (_v3.$ === 1) {
								return _Utils_Tuple2(
									s,
									bump(key));
								...
								var iid = _v3.a;
								return _Utils_Tuple2(
									A3($author$project$Main$addDamageHp, iid, count * 10, s),
									bump(key));
							}
						case 39:
							var count = _v1.a.l;
							...
							var to = _v1.a.bn;
							var s1 = function () {
								var _v5 = A3($author$project$Main$firstInstance, from.d, from.e.T, postInstances);
								if (_v5.$ === 1) {
									return s;
								} else {
									var iid = _v5.a;
									return A3($author$project$Main$addDamageHp, iid, -(count * 10), s);
								}
							}();
							var s2 = function () {
								var _v4 = A3($author$project$Main$firstInstance, to.d, to.e.T, postInstances);
								if (_v4.$ === 1) {
									return s1;
								} else {
									var iid = _v4.a;
									return A3($author$project$Main$addDamageHp, iid, count * 10, s1);
								}
							}();
							return _Utils_Tuple2(s2, counts);
						case 16:
							var pokemon = _v1.a.t;
							var key = _Utils_Tuple2(pokemon.d, pokemon.e.T);
							var n = ordinal(key);
							var _v6 = A4($author$project$Main$nthInstance, pokemon.d, pokemon.e.T, n, preInstances);
							if (_v6.$ === 1) {
								return _Utils_Tuple2(
									s,
									bump(key));
						...
						case 40:
							var pokemon = _v1.a.t;
							var amount = _v1.a.br;
							var _v7 = A3($author$project$Main$firstInstance, pokemon.d, pokemon.e.T, postInstances);
							if (_v7.$ === 1) {
			...
			_Utils_Tuple2(state1, $elm$core$Dict$empty),
			group.bC).a;
		return state2;
	});
var $author$project$Main$emptyDamage = $elm$core$Dict$empty;
var $author$project$Main$computeDamage = F4(
	function (players, replay, sectionIndex, groupIndex) {
		var groups = A4($author$project$Main$collectAndCorrectGroups, players, replay, sectionIndex, groupIndex);
		return A3(
			$elm$core$List$foldl,
			F2(
				function (group, _v0) {
					...
					var dmg = _v0.b;
					var pre = inst;
					var post = A2($author$project$Main$applyGroupToInstances, group, inst);
					return _Utils_Tuple2(
						post,
						A4($author$project$Main$applyGroupToDamage, pre, post, group, dmg));
				}),
			_Utils_Tuple2($author$project$Main$emptyInstances, $author$project$Main$emptyDamage),
			groups).b;
	});
var $author$project$Main$computeInstances = F4(
	function (players, replay, sectionIndex, groupIndex) {
		return A3(
			$elm$core$List$foldl,
			$author$project$Main$applyGroupToInstances,
			$author$project$Main$emptyInstances,
			A4($author$project$Main$collectAndCorrectGroups, players, replay, sectionIndex, groupIndex));
	});
var $author$project$Main$pilesDeckDelta = F4(
	function (red, player, delta, piles) {
		return _Utils_eq(player, red) ? _Utils_update(
			piles,
			{aC: piles.aC + delta}) : _Utils_update(
			piles,
			{aB: piles.aB + delta});
	});
var $author$project$Main$applyDeckDiscardCorrection = F4(
	function (red, hand, group, piles) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (detail, p) {
					...
					if (_v0.$ === 35) {
						var player = _v0.a.d;
						var card = _v0.a.e;
						return (!A4($author$project$Main$cardIsInHand, red, player, card.T, hand)) ? A4($author$project$Main$pilesDeckDelta, red, player, -1, p) : p;
					} else {
						return p;
					}
				}),
...
var $author$project$Main$pilesDiscardDelta = F4(
	function (red, player, delta, piles) {
		return _Utils_eq(player, red) ? _Utils_update(
			piles,
			{aE: piles.aE + delta}) : _Utils_update(
			piles,
			{aD: piles.aD + delta});
	});
var $author$project$Main$pilesPrizeDelta = F4(
	function (red, player, delta, piles) {
		return _Utils_eq(player, red) ? _Utils_update(
			piles,
			{aN: piles.aN + delta}) : _Utils_update(
			piles,
			{aM: piles.aM + delta});
	});
var $author$project$Main$applyActionToPiles = F4(
	function (red, isSetup, action, piles) {
		switch (action.$) {
			case 3:
				var player = action.a.d;
				var count = action.a.l;
			...
			case 31:
				...
				var count = action.a.l;
				return A4(
					$author$project$Main$pilesDeckDelta,
					red,
					player,
					function () {
						if (!card.$) {
			...
			case 6:
				var player = action.a.d;
				var position = action.a.aL;
				return (isSetup && (!position)) ? A4(
					$author$project$Main$pilesPrizeDelta,
					red,
					player,
					6,
					A4($author$project$Main$pilesDeckDelta, red, player, -6, piles)) : piles;
			case 8:
				var player = action.a.d;
				return A4($author$project$Main$pilesDiscardDelta, red, player, 1, piles);
			case 24:
				var pokemon = action.a.t;
				return A4($author$project$Main$pilesDiscardDelta, red, pokemon.d, 1, piles);
			case 25:
				var pokemon = action.a.t;
				var count = action.a.l;
				return A4($author$project$Main$pilesDiscardDelta, red, pokemon.d, count, piles);
			case 34:
				var player = action.a.d;
				var count = action.a.l;
				return A4($author$project$Main$pilesDiscardDelta, red, player, count, piles);
			case 35:
				var player = action.a.d;
				return A4($author$project$Main$pilesDiscardDelta, red, player, 1, piles);
			case 36:
...
var $author$project$Main$applyGroupToPiles = F4(
	function (red, isSetup, piles, group) {
		var piles1 = $author$project$Main$isPokemonAbilityGroup(group) ? piles : A4($author$project$Main$applyActionToPiles, red, isSetup, group.R, piles);
		var deckAttachPlayers = $author$project$Main$isDeckAttachAbilityGroup(group) ? A2(
			$elm$core$List$filterMap,
			function (d) {
				var _v3 = d.R;
			...
			F2(
				function (detail, p) {
					var p1 = function () {
						...
						if (_v2.$ === 13) {
							var player = _v2.a.d;
							return A2($elm$core$List$member, player, deckAttachPlayers) ? A4($author$project$Main$pilesDeckDelta, red, player, -1, p) : A4($author$project$Main$applyActionToPiles, red, isSetup, detail.R, p);
						} else {
							return A4($author$project$Main$applyActionToPiles, red, isSetup, detail.R, p);
						}
					}();
					var p2 = function () {
					...
					return A3(
						...
						F2(
							function (bullet, bp) {
								return A4($author$project$Main$applyActionToPiles, red, isSetup, bullet.R, bp);
							}),
						p2,
						detail.az);
				}),
...
var $author$project$Main$emptyPiles = {aB: 60, aC: 60, aD: 0, aE: 0, aM: 0, aN: 0};
var $author$project$Main$computePiles = F4(
	function (players, replay, sectionIndex, groupIndex) {
		var groupPairs = $elm$core$List$concat(
			A2(
				$elm$core$List$indexedMap,
				F2(
					function (si, section) {
						...
						var groups = $author$project$Action$groupLines(
							$author$project$Main$sectionLines(section));
						var trimmed = (_Utils_cmp(si, sectionIndex) < 0) ? groups : (_Utils_eq(si, sectionIndex) ? A2($elm$core$List$take, groupIndex + 1, groups) : _List_Nil);
						return A2(
							$elm$core$List$map,
							function (g) {
								return _Utils_Tuple2(
									isSetup,
									A3($author$project$Main$correctGroupPlayers, players, $author$project$Main$emptyInstances, g));
							},
							trimmed);
					}),
				replay.y));
		return A3(
			...
			F2(
				function (_v0, _v1) {
					...
					var h = _v1.a;
					var p = _v1.b;
					var p1 = A4($author$project$Main$applyGroupToPiles, players.a, isSetup, p, group);
					var p2 = A4($author$project$Main$applyDeckDiscardCorrection, players.a, h, group, p1);
					var h1 = A3($author$project$Main$applyGroupToHand, players.a, h, group);
					return _Utils_Tuple2(h1, p2);
				}),
			_Utils_Tuple2($author$project$Main$emptyHand, $author$project$Main$emptyPiles),
			groupPairs).b;
	});
...
var $author$project$Main$CloseCard = {$: 15};
...
var $author$project$Main$viewAbilityDetail = function (ability) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'background', '#9f7aea'),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(ability.aF)
					]))
			]));
};
var $author$project$Main$viewEnergyCost = function (energyType) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'font-size', '0.72em'),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(energyType)
			]));
};
var $author$project$Main$viewAttackDetail = function (attack) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(attack.aI)
							])),
						$elm$core$String$isEmpty(attack.cI) ? $elm$html$Html$text('') : A2(
						$elm$html$Html$span,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(attack.cI + ' dmg')
							]))
					])),
				$elm$core$List$isEmpty(attack.a5) ? $elm$html$Html$text('') : A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				...
				A2($elm$core$List$map, $author$project$Main$viewEnergyCost, attack.a5)),
				$elm$core$String$isEmpty(attack.aF) ? $elm$html$Html$text('') : A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'font-size', '0.875rem'),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(attack.aF)
					]))
			]));
};
var $author$project$Main$viewMoveDetail = F2(
	function (cardData, moveName) {
		var maybeAttack = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (a) {
					return _Utils_eq(a.aI, moveName);
				},
				cardData.a3));
		...
		return A2(
			...
			_List_fromArray(
				[
					function () {
					if (!maybeAbility.$) {
						var ability = maybeAbility.a;
						return $author$project$Main$viewAbilityDetail(ability);
					} else {
						if (!maybeAttack.$) {
							var attack = maybeAttack.a;
							return $author$project$Main$viewAttackDetail(attack);
						} else {
							return A2(
								$elm$html$Html$div,
								_List_fromArray(
				...
				switch (popup.$) {
					case 0:
						...
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(fallbackName + '…')
								]));
					case 1:
...
var $author$project$Main$playerColor = F2(
	function (players, name) {
		if (!players.$) {
			var p = players.a;
			return _Utils_eq(name, p.a) ? '#2c5282' : (_Utils_eq(name, p.b) ? '#c53030' : '#2d3748');
		} else {
			return '#2d3748';
		}
	});
var $author$project$Main$viewSectionBadge = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'text-transform', 'uppercase'),
					A2($elm$html$Html$Attributes$style, 'padding', '0.2rem 0.55rem'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '4px')
				]),
			_List_fromArray(
				[
...
var $author$project$Main$sectionNavInfo = F2(
	function (players, maybeSection) {
		if (maybeSection.$ === 1) {
			return _Utils_Tuple3(
				$elm$html$Html$text(''),
				_List_Nil,
			...
			var section = maybeSection.a;
			switch (section.$) {
				case 0:
					return _Utils_Tuple3(
						A2($author$project$Main$viewSectionBadge, '#718096', 'Setup'),
						_List_Nil,
						'#71809640');
				case 1:
					var turn = section.a;
					var badgeColor = A2($author$project$Main$playerColor, players, turn.d);
					return _Utils_Tuple3(
						A2(
							$author$project$Main$viewSectionBadge,
							badgeColor,
							'Turn ' + $elm$core$String$fromInt(turn.b_)),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$span,
								...
								_List_fromArray(
									[
										$elm$html$Html$text(turn.d)
									]))
							]),
						badgeColor + '40');
				case 2:
					return _Utils_Tuple3(
						A2($author$project$Main$viewSectionBadge, '#b7791f', 'Pokémon Checkup'),
						_List_Nil,
						'#b7791f40');
				default:
					return _Utils_Tuple3(
						A2($author$project$Main$viewSectionBadge, '#718096', 'Result'),
						_List_Nil,
						'#71809640');
			}
		}
...
var $author$project$Main$splitByPhrase = F2(
	function (highlight, str) {
		...
		if ($elm$core$String$isEmpty(phrase)) {
			...
			var _v0 = A2($elm$core$String$split, phrase, str);
			if (!_v0.b) {
				return _List_Nil;
			} else {
				if (!_v0.b.b) {
					var only = _v0.a;
					return $elm$core$String$isEmpty(only) ? _List_Nil : _List_fromArray(
						[
							$author$project$Main$PlainText(only)
						]);
				} else {
					var parts = _v0;
					var interleave = function (ps) {
						if (!ps.b) {
							return _List_Nil;
						} else {
							if (!ps.b.b) {
								var last = ps.a;
								return $elm$core$String$isEmpty(last) ? _List_Nil : _List_fromArray(
									[
										$author$project$Main$PlainText(last)
									]);
							} else {
								var first = ps.a;
								var rest = ps.b;
								return _Utils_ap(
									$elm$core$String$isEmpty(first) ? _List_Nil : _List_fromArray(
										[
											$author$project$Main$PlainText(first)
										]),
									A2(
										$elm$core$List$cons,
										A3($author$project$Main$MoveRef, phrase, highlight.ba, highlight.ag),
										interleave(rest)));
							}
						}
					};
...
var $author$project$Main$applyHighlights = F2(
	function (maybeHighlight, segs) {
		if (maybeHighlight.$ === 1) {
			return segs;
		} else {
			...
			return A2(
				...
				function (seg) {
					if (!seg.$) {
						var str = seg.a;
						return A2($author$project$Main$splitByPhrase, highlight, str);
					} else {
						var other = seg;
						return _List_fromArray(
							[other]);
...
var $author$project$Main$splitByPlayer = F3(
	function (playerName, color, str) {
		if ($elm$core$String$isEmpty(playerName)) {
			...
			var _v0 = A2($elm$core$String$split, playerName, str);
			if (!_v0.b) {
				return _List_Nil;
			} else {
				if (!_v0.b.b) {
						...
						if (!ps.b) {
							...
							if (!ps.b.b) {
								...
								return _Utils_ap(
									...
									A2(
										$elm$core$List$cons,
										A2($author$project$Main$PlayerRef, playerName, color),
										interleave(rest)));
							}
						}
					};
...
var $author$project$Main$segmentPlayers = F2(
	function (maybePlayers, str) {
		if (maybePlayers.$ === 1) {
			return $elm$core$String$isEmpty(str) ? _List_Nil : _List_fromArray(
				[
					$author$project$Main$PlainText(str)
			...
			return A2(
				...
				function (seg) {
					if (!seg.$) {
						var s = seg.a;
						return A3($author$project$Main$splitByPlayer, players.b, '#c53030', s);
					} else {
						var other = seg;
						return _List_fromArray(
							[other]);
				...
				A3($author$project$Main$splitByPlayer, players.a, '#2c5282', str));
		}
	});
...
var $author$project$Main$segmentText = F2(
	function (players, str) {
		var _v0 = A2($elm$core$String$split, '(', str);
		if (!_v0.b) {
			return _List_Nil;
...
var $author$project$Main$CardClicked = F2(
	function (a, b) {
		return {$: 10, a: a, b: b};
	});
		...
		case 1:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						A2($author$project$Main$CardClicked, id, name)),
						A2($elm$html$Html$Attributes$style, 'font-size', '0.8em'),
						A2($elm$html$Html$Attributes$style, 'font-weight', '600'),
						A2(
		...
		case 3:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						A2($author$project$Main$MoveClicked, cardId, name)),
						A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
						A2($elm$html$Html$Attributes$style, 'font-size', '0.8em'),
						A2($elm$html$Html$Attributes$style, 'font-weight', '600'),
						A2($elm$html$Html$Attributes$style, 'padding', '0.1em 0.45em'),
						...
						if (!kind.$) {
							if (!kind.a) {
								var _v2 = kind.a;
								return A2($elm$html$Html$Attributes$style, 'background', '#9f7aea');
							} else {
								var _v3 = kind.a;
								return A2($elm$html$Html$Attributes$style, 'background', '#ed8936');
							}
						} else {
							return A2($elm$html$Html$Attributes$style, 'background', '#e2e8f0');
						}
					}(),
						function () {
						if (kind.$ === 1) {
							return A2($elm$html$Html$Attributes$style, 'color', '#4a5568');
						} else {
...
var $author$project$Main$viewInlineText = F3(
	function (players, highlight, str) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$viewSegment,
			A2(
				$author$project$Main$applyHighlights,
				highlight,
				A2($author$project$Main$segmentText, players, str)));
	});
var $author$project$Main$viewLine = F3(
	function (players, highlight, line) {
		switch (line.$) {
			case 0:
				var content = line.a;
				return A2(
					...
					A3($author$project$Main$viewInlineText, players, highlight, content));
			case 1:
				var content = line.a;
				return A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'padding', '0.15rem 0 0.15rem 1.25rem'),
							A2($elm$html$Html$Attributes$style, 'font-size', '0.875rem'),
							A2($elm$html$Html$Attributes$style, 'color', '#4a5568'),
							A2($elm$html$Html$Attributes$style, 'line-height', '1.5')
						]),
			...
			default:
				...
				return A2(
					...
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'padding', '0.1rem 0 0.1rem 2.5rem'),
...
var $author$project$Main$viewActionGroup = F5(
	function (ctx, preInstances, players, cache, group) {
		var viewDetailLines = F2(
			function (wasCorrected, detail) {
				var detailLine = A3(
					$author$project$Main$viewLine,
					players,
					$elm$core$Maybe$Nothing,
					$author$project$Replay$DetailLine(detail.X));
				var wrappedLine = (ctx.S && wasCorrected) ? A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'background-color', 'rgba(237, 137, 54, 0.15)'),
							A2($elm$html$Html$Attributes$style, 'border-left', '3px solid #ed8936'),
					...
					A2(
						...
						function (bullet) {
							return A3(
								...
								players,
								$elm$core$Maybe$Nothing,
								$author$project$Replay$BulletLine(bullet.X));
						},
						detail.az));
			});
		var topHighlight = function () {
			...
			if (_v4.$ === 15) {
				...
				var cardId = attacker.e.T;
				var kind = function () {
					var _v5 = A2($elm$core$Dict$get, cardId, cache);
					if (!_v5.$) {
						var cardData = _v5.a;
						return A2(
							$elm$core$List$any,
							function (a) {
								return _Utils_eq(a.aI, cleaned);
							},
							cardData.a1) ? $elm$core$Maybe$Just(0) : (A2(
							$elm$core$List$any,
							function (a) {
								return _Utils_eq(a.aI, cleaned);
							},
							cardData.a3) ? $elm$core$Maybe$Just(1) : $elm$core$Maybe$Nothing);
					} else {
						return $elm$core$Maybe$Nothing;
					}
				}();
				return $elm$core$Maybe$Just(
					{ag: cardId, ba: kind, bg: cleaned});
			} else {
				return $elm$core$Maybe$Nothing;
			}
		}();
		var correctedGroup = function () {
			if (!players.$) {
				var ps = players.a;
				return A3($author$project$Main$correctGroupPlayers, ps, preInstances, group);
			} else {
				return group;
			}
		}();
		var wasDetailCorrected = A3(
			$elm$core$List$map2,
			F2(
				function (orig, corr) {
					return !_Utils_eq(orig.X, corr.X);
				}),
			group.bC,
			correctedGroup.bC);
		var normalDetails = $elm$core$List$concat(
			A3($elm$core$List$map2, viewDetailLines, wasDetailCorrected, correctedGroup.bC));
		var _v0 = group.R;
		if (_v0.$ === 15) {
			var target = _v0.a.a_;
			var modifier = _v0.a.bd;
			if (!target.$) {
				var damage = target.a.cI;
				if ((!_Utils_eq(modifier, $elm$core$Maybe$Nothing)) || A2(
					...
					A2(
						$elm$core$Maybe$map,
						function (d) {
							return d.X === 'Damage breakdown:';
						},
						$elm$core$List$head(correctedGroup.bC)))) {
					var nonBreakdownDetails = $elm$core$List$concat(
						A3($elm$core$List$map2, viewDetailLines, wasDetailCorrected, correctedGroup.bC));
					var forDamage = ' for ' + ($elm$core$String$fromInt(damage) + ' damage.');
					var prefixIdx = $elm$core$List$head(
						A2($elm$core$String$indexes, forDamage, group.X));
					var breakdownLines = A2(
						...
						A2(
							...
							correctedGroup.bC));
					var damageInfo = {a4: breakdownLines};
					var attackPrefixRaw = function () {
						if (!prefixIdx.$) {
							var i = prefixIdx.a;
							return A2($elm$core$String$left, i, group.X);
						} else {
							return group.X;
						}
					}();
					...
					return A2(
						...
						A3(
							...
							players,
							topHighlight,
							$author$project$Replay$TopLine(group.X)),
						normalDetails);
				}
			} else {
				return A2(
...
var $author$project$Main$FirstSection = {$: 4};
var $author$project$Main$LastSection = {$: 7};
...
var $author$project$Main$viewNavSection = function (_v0) {
	var badge = _v0.bt;
	var extra = _v0.bG;
	var borderColor = _v0.bv;
	var content = _v0.bz;
	var hasPrev = _v0.bN;
	var hasNext = _v0.bM;
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3($author$project$Main$navArrow, hasPrev, $author$project$Main$FirstSection, '«'),
								A3($author$project$Main$navArrow, hasPrev, $author$project$Main$PrevSection, '‹')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'display', 'flex'),
								A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
								A2($elm$html$Html$Attributes$style, 'gap', '0.6rem')
							]),
						A2($elm$core$List$cons, badge, extra)),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A3($author$project$Main$navArrow, hasNext, $author$project$Main$NextSection, '›'),
								A3($author$project$Main$navArrow, hasNext, $author$project$Main$LastSection, '»')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('action-content'),
						A2($elm$html$Html$Attributes$style, 'border-left', '3px solid ' + borderColor),
						A2($elm$html$Html$Attributes$style, 'padding-left', '0.75rem'),
...
var $author$project$Main$viewResultContent = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'color',
							A2($author$project$Main$playerColor, players, result.cq)),
							A2($elm$html$Html$Attributes$style, 'padding', '0.2rem 0')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(result.cq + ' wins.')
						]))
				]));
	});
var $author$project$Main$viewPastSectionGroups = F5(
	function (ctx, cache, players, section, groupsWithPre) {
		var greyed = function (children) {
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
		...
		if (section.$ === 3) {
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Main$viewResultContent, players, result)
						]))
				]);
		} else {
			return A2(
				...
				function (_v1) {
					...
					var pre = _v1.b;
					return greyed(
						A5($author$project$Main$viewActionGroup, ctx, pre, players, cache, group));
				},
				$elm$core$List$reverse(groupsWithPre));
		}
	});
var $author$project$Main$viewSectionDivider = F2(
	function (players, section) {
		var _v0 = function () {
			switch (section.$) {
				case 0:
					return _Utils_Tuple2('Setup', '#718096');
				case 1:
					var turn = section.a;
					return _Utils_Tuple2(
						'Turn ' + ($elm$core$String$fromInt(turn.b_) + (' · ' + turn.d)),
						A2($author$project$Main$playerColor, players, turn.d));
				case 2:
					return _Utils_Tuple2('Pokémon Checkup', '#b7791f');
				default:
					return _Utils_Tuple2('Result', '#718096');
			}
		}();
		var label = _v0.a;
		var color = _v0.b;
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'background', '#cbd5e0')
						]),
					_List_Nil),
					A2(
					$elm$html$Html$span,
...
var $author$project$Main$viewReplay = F5(
	function (ctx, cache, replay, sectionIndex, groupIndex) {
		var total = $elm$core$List$length(replay.y);
		var players = replay.W;
		var sectionsWithPres = function () {
			if (players.$ === 1) {
				return A2(
					$elm$core$List$map,
					function (sec) {
						return _Utils_Tuple2(sec, _List_Nil);
					},
					replay.y);
			} else {
				var ps = players.a;
					...
					A3(
						...
						F2(
							function (section, _v7) {
								var state = _v7.a;
								var acc = _v7.b;
								var rawGroups = $author$project$Action$groupLines(
									$author$project$Main$sectionLines(section));
								var _v8 = A3(
									$elm$core$List$foldl,
									F2(
										function (group, _v9) {
											var s = _v9.a;
											var gacc = _v9.b;
											var corrected = A3($author$project$Main$correctGroupPlayers, ps, s, group);
											var nextState = A2($author$project$Main$applyGroupToInstances, corrected, s);
											return _Utils_Tuple2(
												nextState,
												A2(
													$elm$core$List$cons,
								...
								return _Utils_Tuple2(
									...
									A2(
										...
										_Utils_Tuple2(
											section,
											$elm$core$List$reverse(revGroupsWithPre)),
										acc));
							}),
						_Utils_Tuple2($author$project$Main$emptyInstances, _List_Nil),
						replay.y).b);
		...
		var pastSectionsWithPre = A2($elm$core$List$take, sectionIndex, sectionsWithPres);
		var pastContent = A2(
			$elm$core$List$concatMap,
			function (_v5) {
				var section = _v5.a;
				var groupsWithPre = _v5.b;
				return A2(
					$elm$core$List$cons,
					A2($author$project$Main$viewSectionDivider, players, section),
					A5($author$project$Main$viewPastSectionGroups, ctx, cache, players, section, groupsWithPre));
			},
			$elm$core$List$reverse(pastSectionsWithPre));
		var hasPrev = (groupIndex > 0) || (sectionIndex > 0);
		var currentSectionWithPre = $elm$core$List$head(
			A2($elm$core$List$drop, sectionIndex, sectionsWithPres));
		var currentSection = A2($elm$core$Maybe$map, $elm$core$Tuple$first, currentSectionWithPre);
		var totalGroupsInCurrent = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Maybe$map, $author$project$Main$sectionGroupCount, currentSection));
		var hasNext = (_Utils_cmp(groupIndex, totalGroupsInCurrent - 1) < 0) || (_Utils_cmp(sectionIndex, total - 1) < 0);
		var currentContent = function () {
			if (currentSectionWithPre.$ === 1) {
				return _List_Nil;
			} else {
				var _v2 = currentSectionWithPre.a;
				var section = _v2.a;
				var groupsWithPre = _v2.b;
				if (section.$ === 3) {
					var result = section.a;
					return _List_fromArray(
						[
					...
					return A2(
						...
						$elm$core$List$reverse(
							A2($elm$core$List$take, groupIndex + 1, groupsWithPre)));
				}
			}
		}();
		var _v0 = A2($author$project$Main$sectionNavInfo, players, currentSection);
		var badge = _v0.a;
		var extra = _v0.b;
		...
		return $author$project$Main$viewNavSection(
			{
				bt: badge,
				bv: borderColor,
				bz: _Utils_ap(currentContent, pastContent),
				bG: extra,
				bM: hasNext,
				bN: hasPrev
			});
	...
	switch (model.$) {
		...
		case 1:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Loading replay…')
					]));
		case 2:
			return A2(
				$elm$html$Html$div,
		...
		case 3:
			var replay = model.b;
			var index = model.c;
			var groupIndex = model.d;
			var cache = model.f;
			var ctx = model.g;
			return A5($author$project$Main$viewReplay, ctx, cache, replay, index, groupIndex);
		default:
			return $elm$html$Html$text('');
	}
};
...
var $author$project$Main$cachedImageUrl = F2(
	function (cache, card) {
		var _v0 = A2(
			$elm$core$Maybe$andThen,
			function ($) {
			...
			A2($elm$core$Dict$get, card.T, cache));
		if (!_v0.$) {
			var url = _v0.a;
			...
			return $elm$core$List$head(
				A2(
					...
					function (data) {
						return _Utils_eq(
							data.aI,
							$elm$core$Maybe$Just(card.aI)) ? data.ak : $elm$core$Maybe$Nothing;
					},
					$elm$core$Dict$values(cache)));
		}
	});
var $author$project$Main$handCardImage = F2(
	function (cache, maybeCard) {
		if (maybeCard.$ === 1) {
			return $elm$core$Maybe$Nothing;
		} else {
			...
			return A2(
				...
				A2($author$project$Main$cachedImageUrl, cache, card));
		}
	});
var $author$project$Main$stripBenchedFromBenchSide = F2(
	function (benched, benchSide) {
		var unknownCount = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
		...
		var removeFirst = F2(
			function (ref, acc) {
				if (!acc.b) {
					...
					var c = acc.a;
					var rest = acc.b;
					return _Utils_eq(c.T, ref.T) ? rest : A2(
						$elm$core$List$cons,
						c,
						A2(removeFirst, ref, rest));
				}
			});
		var knownBenched = A2($elm$core$List$filterMap, $elm$core$Basics$identity, benched);
		var afterKnown = A3($elm$core$List$foldl, removeFirst, benchSide, knownBenched);
		return A2(
			$elm$core$List$take,
			A2(
				$elm$core$Basics$max,
				0,
				$elm$core$List$length(afterKnown) - unknownCount),
			afterKnown);
	});
var $author$project$Main$removeKnownFromHandSide = F2(
	function (toRemove, handSide) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (ref, acc) {
...
var $author$project$Main$removeLastNUnknowns = F2(
	function (n, handSide) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (card, _v0) {
					var remaining = _v0.a;
					var acc = _v0.b;
					return ((remaining > 0) && _Utils_eq(card, $elm$core$Maybe$Nothing)) ? _Utils_Tuple2(remaining - 1, acc) : _Utils_Tuple2(
						remaining,
						A2($elm$core$List$cons, card, acc));
				}),
			_Utils_Tuple2(n, _List_Nil),
			$elm$core$List$reverse(handSide)).b;
	});
var $author$project$Main$stripDrawnFromHandSide = F2(
	function (drawn, handSide) {
		var unknownCount = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				$elm$core$Basics$eq($elm$core$Maybe$Nothing),
				drawn));
		return A2(
			$author$project$Main$removeLastNUnknowns,
			unknownCount,
			A2(
				$author$project$Main$removeKnownFromHandSide,
...
var $author$project$Main$isTookPrizePlay = function (play) {
	return _Utils_eq(play.e, $elm$core$Maybe$Nothing) && ($elm$core$List$isEmpty(play.a.E) && $elm$core$List$isEmpty(play.b.E));
};
...
var $author$project$Main$isEnergyAttachment = F2(
	function (cache, item) {
		var _v0 = A2($elm$core$Dict$get, item.T, cache);
		if (!_v0.$) {
			var cardData = _v0.a;
			var _v1 = cardData.bw;
			if (!_v1.$) {
				...
				return A2(
					...
					'energy',
					$elm$core$String$toLower(item.aI));
			}
		} else {
			return A2(
				$elm$core$String$contains,
...
var $author$project$Main$abbreviateCardName = function (name) {
...
var $author$project$Main$basicEnergyColor = function (apiName) {
	var key = A2($elm$core$String$startsWith, 'Basic ', apiName) ? A2($elm$core$String$dropLeft, 6, apiName) : apiName;
	switch (key) {
		case 'Grass Energy':
			return $elm$core$Maybe$Just('#4ade80');
		case 'Water Energy':
			return $elm$core$Maybe$Just('#60a5fa');
		case 'Fire Energy':
			return $elm$core$Maybe$Just('#f87171');
		case 'Lightning Energy':
			return $elm$core$Maybe$Just('#facc15');
		case 'Fighting Energy':
			return $elm$core$Maybe$Just('#fb923c');
		case 'Psychic Energy':
			return $elm$core$Maybe$Just('#c084fc');
		case 'Darkness Energy':
			return $elm$core$Maybe$Just('#818cf8');
		case 'Metal Energy':
			return $elm$core$Maybe$Just('#94a3b8');
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$viewAttachmentCircle = F2(
	function (cache, item) {
		var maybeUrl = A2(
			...
			A2($author$project$Main$cachedImageUrl, cache, item));
		var isBasicEnergy = !_Utils_eq(
			$author$project$Main$basicEnergyImageUrl(item.aI),
			$elm$core$Maybe$Nothing);
		var bgPosition = isBasicEnergy ? 'center 55%' : 'center 30%';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'background-size', '150%'),
									A2($elm$html$Html$Attributes$style, 'background-position', bgPosition)
								]),
							_List_Nil);
					} else {
						var _v1 = $author$project$Main$basicEnergyColor(item.aI);
						if (!_v1.$) {
							var color = _v1.a;
							return A2(
								$elm$html$Html$div,
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$abbreviateCardName(item.aI))
									]));
						}
					}
				}()
...
var $author$project$Main$viewAttachmentRect = F2(
	function (cache, item) {
		var maybeUrl = A2(
			$elm$core$Maybe$map,
			function (u) {
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'background-image', 'url(\'' + (u + '\')')),
									A2($elm$html$Html$Attributes$style, 'background-size', '150%'),
									A2($elm$html$Html$Attributes$style, 'background-position', 'center 20%')
								]),
							_List_Nil);
					} else {
						return A2(
	...
	function (upsideDown, cache, cardAttachments, hpDamage, conditions, card) {
		...
		var cardStyles = _List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
				$elm$html$Html$Events$onClick(
				A2($author$project$Main$CardClicked, card.T, card.aI))
			]);
		var cardDiv = function () {
			if (!maybeUrl.$) {
				...
				return A2(
					...
					_Utils_ap(cardStyles, rotStyles),
					card.aI);
			}
		}();
		var toolAttachments = A2(
			$elm$core$List$filter,
			function (a) {
		...
		var energyAttachments = A2(
			...
			A2(
				...
				cardAttachments));
		var groupedEnergies = $elm$core$List$reverse(
			A3(
				$elm$core$List$foldl,
				F2(
					function (item, acc) {
				...
				A2(
					...
					function (_v1) {
						...
						return A2(
							...
							A2(
								$elm$core$List$cons,
								A2($author$project$Main$viewAttachmentCircle, cache, item),
									...
									[
										...
										_List_fromArray(
											[
												...
												A2($elm$html$Html$Attributes$style, 'font-weight', '700'),
												A2($elm$html$Html$Attributes$style, 'color', 'white'),
												A2($elm$html$Html$Attributes$style, 'text-shadow', '0 0 3px rgba(0,0,0,0.8)'),
...
var $author$project$Main$UnknownPlayCards = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$collapseUnknowns = function (cards) {
	var unknownCount = $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			$elm$core$Basics$eq($elm$core$Maybe$Nothing),
	...
	var known = A2(
		$elm$core$List$filterMap,
		$elm$core$Maybe$map($author$project$Main$KnownPlayCard),
		cards);
	return (unknownCount > 0) ? A2(
		$elm$core$List$cons,
		$author$project$Main$UnknownPlayCards(unknownCount),
		known) : known;
};
var $author$project$Main$viewKnownCardThumb = F3(
	function (upsideDown, cache, card) {
		...
		if (!maybeUrl.$) {
			...
			return A2($author$project$Main$viewNoImageCard, baseStyles, card.aI);
		}
	});
var $author$project$Main$viewUnknownCardBack = F4(
	function (w, h, upsideDown, count) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'flex-shrink', '0'),
					A2($elm$html$Html$Attributes$style, 'box-sizing', 'border-box'),
					A2($elm$html$Html$Attributes$style, 'background', '#bfdbfe'),
					A2($elm$html$Html$Attributes$style, 'border', '2px solid #1e40af'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
					A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
					A2($elm$html$Html$Attributes$style, 'font-size', '1rem'),
					A2($elm$html$Html$Attributes$style, 'font-weight', '700'),
					A2($elm$html$Html$Attributes$style, 'color', '#1e40af'),
					A2(
					$elm$html$Html$Attributes$style,
					'transform',
...
var $author$project$Main$viewPlayerPlayInfo = F6(
	function (cache, upsideDown, isTookPrize, color, playerCards, maybePlayedCard) {
		...
		var optionalGroup = F2(
			function (label, cards) {
				return $elm$core$List$isEmpty(cards) ? _List_Nil : _List_fromArray(
					[
						A2(labeledGroup, label, cards)
					]);
			});
		var cardGroups = isTookPrize ? A2(optionalGroup, 'Prizes taken', playerCards.K) : _Utils_ap(
			function () {
				if (!maybePlayedCard.$) {
					var card = maybePlayedCard.a;
					return _List_fromArray(
						[
							A2(
							labeledGroup,
			...
			_Utils_ap(
				A2(optionalGroup, 'Discarded', playerCards.E),
				_Utils_ap(
					A2(optionalGroup, 'Shuffled', playerCards.ad),
					_Utils_ap(
						A2(optionalGroup, 'Drawn', playerCards.K),
						A2(optionalGroup, 'Benched', playerCards.M)))));
		return $elm$core$List$isEmpty(cardGroups) ? $elm$html$Html$text('') : A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
...
var $author$project$Main$viewBenchRow = F8(
	function (upsideDown, cache, bgColor, instances, attachments, damageState, player, cards) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'padding', '10px 10px 14px 14px'),
						...
						F2(
							function (card, _v0) {
								...
								var ordinal = A2(
									$elm$core$Maybe$withDefault,
									0,
									A2($elm$core$Dict$get, card.T, counts));
								var maybeIid = A4($author$project$Main$instanceIdForField, instances, player, card.T, ordinal);
								var hp = A2(
									$elm$core$Maybe$withDefault,
									0,
									A2(
								...
								return _Utils_Tuple2(
									_Utils_ap(
										...
										_List_fromArray(
											[cardHtml])),
									A3($elm$core$Dict$insert, card.T, ordinal + 1, counts));
							}),
...
var $author$project$Main$viewHandRow = F6(
	function (playerName, upsideDown, color, alignItems, cards, imageFor) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Main$viewPileStack = F4(
	function (label, count, bgColor, textColor) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Main$viewPrizeStack = F2(
...
var $author$project$Main$viewPlayerPiles = F5(
	function (prizesOnTop, deckCount, discardCount, prizeCount, color) {
		var prize = A2($author$project$Main$viewPrizeStack, prizeCount, color);
		var deckBin = A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A4($author$project$Main$viewPileStack, 'Deck', deckCount, '#bfdbfe', '#1e40af'),
					A4($author$project$Main$viewPileStack, 'Bin', discardCount, '#718096', 'white')
				]));
		var children = prizesOnTop ? _List_fromArray(
			[prize, deckBin]) : _List_fromArray(
			[deckBin, prize]);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Main$viewHandState = function (players) {
	return function (cache) {
		return function (flipOpponent) {
...
var $author$project$Main$FlipOpponentToggled = {$: 14};
var $author$project$Main$viewSettings = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'flex-shrink', '0'),
				A2($elm$html$Html$Attributes$style, 'padding', '0.4rem 0'),
				A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				A2($elm$html$Html$Attributes$style, 'flex-direction', 'column'),
				A2($elm$html$Html$Attributes$style, 'gap', '0.35rem')
			]),
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'gap', '0.5rem'),
						A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
						$elm$html$Html$Events$onClick($author$project$Main$FlipOpponentToggled)
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										'left',
										flip ? '17px' : '3px'),
										A2($elm$html$Html$Attributes$style, 'transition', 'left 0.15s')
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Flip opponent\'s cards')
							])),
						debug ? A2(
						$elm$html$Html$span,
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'padding', '0.1rem 0.4rem'),
								A2($elm$html$Html$Attributes$style, 'border-radius', '4px'),
								A2($elm$html$Html$Attributes$style, 'background', 'rgba(237, 137, 54, 0.15)'),
								A2($elm$html$Html$Attributes$style, 'border', '1px solid #ed8936'),
								A2($elm$html$Html$Attributes$style, 'font-size', '0.65rem'),
								A2($elm$html$Html$Attributes$style, 'color', '#c05621'),
								A2($elm$html$Html$Attributes$style, 'font-weight', '700'),
								A2($elm$html$Html$Attributes$style, 'letter-spacing', '0.05em'),
								A2($elm$html$Html$Attributes$style, 'user-select', 'none')
							]),
...
var $author$project$Main$LoadClicked = {$: 1};
...
var $author$project$Main$viewUrlBar = function (model) {
	var url = $author$project$Main$currentUrl(model);
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$placeholder('Paste a raw replay file URL…'),
								$elm$html$Html$Attributes$value(url),
								$elm$html$Html$Events$onInput($author$project$Main$UrlChanged),
								$author$project$Main$onEnter($author$project$Main$LoadClicked),
								A2($elm$html$Html$Attributes$style, 'flex', '1'),
								A2($elm$html$Html$Attributes$style, 'min-width', '0'),
								A2($elm$html$Html$Attributes$style, 'padding', '0.6rem 0.75rem'),
								A2($elm$html$Html$Attributes$style, 'font-size', '0.95rem'),
								A2(
								$elm$html$Html$Attributes$style,
								'border',
								hasError ? '1px solid #fc8181' : '1px solid #cbd5e0'),
								A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$LoadClicked),
								A2($elm$html$Html$Attributes$style, 'padding', '0.6rem 1.5rem'),
								A2(
								$elm$html$Html$Attributes$style,
								'background',
								isLoading ? '#a0aec0' : '#4a5568'),
								A2($elm$html$Html$Attributes$style, 'color', 'white'),
								A2($elm$html$Html$Attributes$style, 'border', 'none'),
								A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
								A2(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', '#e53e3e'),
								A2($elm$html$Html$Attributes$style, 'font-size', '0.875rem')
							]),
						_List_fromArray(
							[
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'display', 'flex'),
						A2($elm$html$Html$Attributes$style, 'flex-direction', 'row'),
						A2($elm$html$Html$Attributes$style, 'gap', '1.5rem'),
						A2($elm$html$Html$Attributes$style, 'margin-top', '0.5rem')
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								if (model.$ === 3) {
									...
									if (!_v1.$) {
										var players = _v1.a;
										var stadium = A4($author$project$Main$computeStadium, players, replay, sectionIndex, groupIndex);
										var piles = A4($author$project$Main$computePiles, players, replay, sectionIndex, groupIndex);
										var maybePlay = A2(
											$elm$core$Maybe$andThen,
											$author$project$Main$currentPlayFromGroup(players),
											A3($author$project$Main$getCurrentGroup, replay, sectionIndex, groupIndex));
				...
				function (replayUrl) {
					return A2(
						...
						function (groupIndex) {
							return A2(
								$elm$json$Json$Decode$andThen,
								function (flipOpponent) {
									return A2(
										$elm$json$Json$Decode$andThen,
										function (debug) {
											return $elm$json$Json$Decode$succeed(
												{S: debug, h: flipOpponent, B: groupIndex, b8: replayUrl, aZ: sectionIndex});
										},
										A2($elm$json$Json$Decode$field, 'debug', $elm$json$Json$Decode$bool));
								},
								A2($elm$json$Json$Decode$field, 'flipOpponent', $elm$json$Json$Decode$bool));
						},
						A2($elm$json$Json$Decode$field, 'groupIndex', $elm$json$Json$Decode$int));
				},
				A2($elm$json$Json$Decode$field, 'replayUrl', $elm$json$Json$Decode$string));
		},
		A2($elm$json$Json$Decode$field, 'sectionIndex', $elm$json$Json$Decode$int)))(0)}});}(this));